! function(t, e) {
    ...
    function n(t) {
        ...
        var r = e(t),
            ...
            s = r.overflowX,
            a = r.overflowY;
        return /(auto|scroll|overlay)/.test(o + a + s) ? t : n(i(t))
    }
    ...
    function s(t) {
        ...
        var r = n && n.nodeName;
        return r && "BODY" !== r && "HTML" !== r ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === e(n, "position") ? s(n) : n : t ? t.ownerDocument.documentElement : document.documentElement
    }
    ...
    function l(t, e) {
        ...
        if (t !== c && e !== c || n.contains(r)) return function(t) {
            var e = t.nodeName;
    ...
    function h(t, e, i, n) {
        return N(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], o(10) ? parseInt(i["offset" + t]) + parseInt(n["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }
    ...
    function g(t, i) {
        var r = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
            ...
            g = parseFloat(h.borderLeftWidth);
        r && a && (c.top = N(c.top, 0), c.left = N(c.left, 0));
        var y = f({
            top: l.top - c.top - p,
        ...
        if (y.marginTop = 0, y.marginLeft = 0, !s && a) {
            var v = parseFloat(h.marginTop),
                b = parseFloat(h.marginLeft);
            y.top -= p - v, y.bottom -= p - v, y.left -= g - b, y.right -= g - b, y.marginTop = v, y.marginLeft = b
        }
        return (s && !r ? i.contains(d) : i === d && "BODY" !== d.nodeName) && (y = u(y, i)), y
    }
    ...
    function y(t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
            ...
            o = N(i.clientHeight, window.innerHeight || 0),
            s = e ? 0 : c(i),
            a = e ? 0 : c(i, "left");
        return f({
    ...
    function C(t, e, i) {
        ...
        var n = P(t),
            ...
            l = o ? "height" : "width",
            c = o ? "width" : "height";
        return r[s] = e[s] + e[l] / 2 - n[l] / 2, r[a] = i === a ? e[a] - n[c] : e[E(a)], r
    }
    ...
    function O(t, e, i, r) {
        i.updateBound = r, I(t).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var o = n(t);
        return function t(e, i, r, o) {
            ...
            a.addEventListener(i, r, {
                passive: !0
            }), s || t(n(a.parentNode), i, r, o), o.push(a)
        ...
        return (c = c.map(function(t, n) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, n) {
                    ...
                    return "vh" === s || "vw" === s ? ("vh" === s ? N(document.documentElement.clientHeight, window.innerHeight || 0) : N(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * o : o
                }(t, r, e, i)
            })
    ...
    var R = Math.min,
        ...
        H = W && !(!window.MSInputMethodContext || !document.documentMode),
        ...
        rt = function() {
            function e(i, n) {
                ...
                }, this.update = q(this.update.bind(this)), this.options = K({}, e.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            t.offsets.reference = x(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = T(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = C(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = j(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                        }
                    }.call(this)
                }
            }, {
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(t, e) {
                    var i, n = e.offset,
                        ...
                        a = o.reference,
                        l = r.split("-")[0];
                    return i = Q(+n) ? [+n, 0] : M(n, s, a, l), "left" === l ? (s.top += i[0], s.left -= i[1]) : "right" === l ? (s.top += i[0], s.left += i[1]) : "top" === l ? (s.left += i[0], s.top -= i[1]) : "bottom" === l && (s.left += i[0], s.top += i[1]), t.popper = s, t
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(t, e) {
                    ...
                    r.top = o, r.left = a, r[n] = l, e.boundaries = c;
                    var u = e.priority,
                        d = t.offsets.popper,
                        h = {
                            primary: function(t) {
                                var i = d[t];
                                return d[t] < c[t] && !e.escapeWithReference && (i = N(d[t], c[t])), G({}, t, i)
                            },
                            secondary: function(t) {
                                var i = "right" === t ? "left" : "top",
                                    n = d[i];
                                return d[t] > c[t] && !e.escapeWithReference && (n = R(d[i], c[t] - ("right" === t ? d.width : d.height))), G({}, i, n)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(t, i) {
                    ...
                    var o = t.placement.split("-")[0],
                        ...
                        m = c ? "bottom" : "right",
                        g = P(r)[u];
                    l[m] - g < a[h] && (t.offsets.popper[h] -= a[h] - (l[m] - g)), l[h] + g > a[m] && (t.offsets.popper[h] += l[h] + g - a[m]), t.offsets.popper = f(t.offsets.popper);
                    var y = l[h] + l[u] / 2 - g / 2,
                        v = e(t.instance.popper),
                        b = parseFloat(v["margin" + d]),
                        _ = parseFloat(v["border" + d + "Width"]),
                        w = y - t.offsets.popper[h] - b - _;
                    return w = N(R(a[u] - g, w), 0), t.arrowElement = r, t.offsets.arrow = (G(n = {}, h, B(w)), G(n, p, ""), n), t
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(t, e) {
                    ...
                    return s.forEach(function(a, l) {
                        ...
                        var c = t.offsets.popper,
                            ...
                            y = "left" === n && p || "right" === n && f || "top" === n && m || "bottom" === n && g,
                            v = -1 !== ["top", "bottom"].indexOf(n),
                            b = !!e.flipVariations && (v && "start" === o && p || v && "end" === o && f || !v && "start" === o && m || !v && "end" === o && g),
                            _ = !!e.flipVariationsByContent && (v && "start" === o && f || v && "end" === o && p || !v && "start" === o && g || !v && "end" === o && m),
                            w = b || _;
                        (h || y || w) && (t.flipped = !0, (h || y) && (n = s[l + 1]), w && (o = function(t) {
                            return "end" === t ? "start" : "start" === t ? "end" : t
                        }(o)), t.placement = n + (o ? "-" + o : ""), t.offsets.popper = K({}, t.offsets.popper, C(t.instance.popper, t.offsets.reference, t.placement)), t = j(t.instance.modifiers, t, "flip"))
                    }), t
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return r[s ? "left" : "top"] = o[i] - (a ? r[s ? "width" : "height"] : 0), t.placement = E(e), t.offsets.popper = f(r), t
                }
            },
            hide: {
                order: 800,
                    ...
                    var a, l, c = void 0 === o ? e.gpuAcceleration : o,
                        ...
                        p = function(t, e) {
                            var i = t.offsets,
                                ...
                                d = e ? c || u || a % 2 == l % 2 ? o : F : s,
                                h = e ? o : s;
                            return {
                                left: d(1 == a % 2 && 1 == l % 2 && !u && e ? n.left - 1 : n.left),
                                top: h(n.top),
                                bottom: h(n.bottom),
                                right: d(n.right)
                            }
                        }(t, 2 > window.devicePixelRatio || !Z),
                        f = "bottom" === i ? "top" : "bottom",
                        g = "right" === n ? "left" : "right",
                        y = Y("transform");
                    if (l = "bottom" == f ? "HTML" === u.nodeName ? -u.clientHeight + p.bottom : -d.height + p.bottom : p.top, a = "right" == g ? "HTML" === u.nodeName ? -u.clientWidth + p.right : -d.width + p.right : p.left, c && y) h[y] = "translate3d(" + a + "px, " + l + "px, 0)", h[f] = 0, h[g] = 0, h.willChange = "transform";
                    else {
                        var v = "bottom" == f ? -1 : 1,
                            b = "right" == g ? -1 : 1;
                        h[f] = l * v, h[g] = a * b, h.willChange = f + ", " + g
                    }
                    var _ = {
                        "x-placement": t.placement
                    };
                    return t.attributes = K({}, _, t.attributes), t.styles = K({}, h, t.styles), t.arrowStyles = K({}, t.offsets.arrow, t.arrowStyles), t
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
            ...
            applyStyle: {
                ...
                fn: function(t) {
                    return z(t.instance.popper, t.styles),
                        ...
                        }(t.instance.popper, t.attributes), t.arrowElement && Object.keys(t.arrowStyles).length && z(t.arrowElement, t.arrowStyles), t
                },
                onLoad: function(t, e, i, n, r) {
                    var o = x(r, e, t, i.positionFixed),
                        s = T(i.placement, o, e, t, i.modifiers.flip.boundariesElement, i.modifiers.flip.padding);
...
function(t, e) {
    ...
    var c = {
        ...
        getTransitionDurationFromElement: function(t) {
            ...
            var e = r.default(t).css("transition-duration"),
                i = r.default(t).css("transition-delay"),
                n = parseFloat(e),
                o = parseFloat(i);
        ...
        triggerTransitionEnd: function(t) {
            r.default(t).trigger("transitionend")
        },
    ...
    c.jQueryDetection(), r.default.fn.emulateTransitionEnd = function(t) {
        var e = this,
            i = !1;
        ...
        h = function() {
            ...
            return e.close = function(t) {
                ...
                var e = c.getSelectorFromElement(t),
                    i = !1;
                return e && (i = document.querySelector(e)), i || (i = r.default(t).closest(".alert")[0]), i
                ...
                if (r.default(t).removeClass("show"), r.default(t).hasClass("fade")) {
                    ...
                    r.default(t).one(c.TRANSITION_END, function(i) {
    ...
    r.default(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', h._handleDismiss(new h)), r.default.fn[u] = h._jQueryInterface, r.default.fn[u].Constructor = h, r.default.fn[u].noConflict = function() {
        return r.default.fn[u] = d, h._jQueryInterface
    };
    var p = r.default.fn.button,
        f = function() {
            ...
            return e.toggle = function() {
                var t = !0,
                    e = !0,
                    i = r.default(this._element).closest('[data-toggle="buttons"]')[0];
                if (i) {
                    ...
                    if (n) {
                        ...
                        t && ("checkbox" !== n.type && "radio" !== n.type || (n.checked = !this._element.classList.contains("active")), this.shouldAvoidTriggerChange || r.default(n).trigger("change")), n.focus(), e = !1
                    }
                }
                this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains("active")), t && r.default(this._element).toggleClass("active"))
            }, e.dispose = function() {
                ...
                return this.each(function() {
                    var n = r.default(this),
                        o = n.data("bs.button");
                    o || (o = new t(this), n.data("bs.button", o)), o.shouldAvoidTriggerChange = i, "toggle" === e && o[e]()
                })
            }, a(t, null, [{
                key: "VERSION",
                get: function() {
    ...
    r.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target,
            i = e;
        if (r.default(e).hasClass("btn") || (e = r.default(e).closest(".btn")[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
        else {
            var n = e.querySelector('input:not([type="hidden"])');
            if (n && (n.hasAttribute("disabled") || n.classList.contains("disabled"))) return void t.preventDefault();
            "INPUT" !== i.tagName && "LABEL" === e.tagName || f._jQueryInterface.call(r.default(e), "toggle", "INPUT" === i.tagName)
        }
    }).on("focus.bs.button.data-api blur.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = r.default(t.target).closest(".btn")[0];
    ...
    }), r.default.fn.button = f._jQueryInterface, r.default.fn.button.Constructor = f, r.default.fn.button.noConflict = function() {
        return r.default.fn.button = p, f._jQueryInterface
    };
    var m = "carousel",
        g = r.default.fn[m],
        y = {
        ...
        _ = function() {
            ...
            return e.next = function() {
                ...
                return t = l({}, y, t), c.typeCheckConfig(m, t, v), t
                ...
                if (this._indicatorsElement) {
                    ...
                    r.default(e).removeClass("active");
                    var i = this._indicatorsElement.children[this._getItemIndex(t)];
                    i && r.default(i).addClass("active")
                }
                ...
                if ("next" === t ? (i = "carousel-item-left", n = "carousel-item-next", o = "left") : (i = "carousel-item-right", n = "carousel-item-prev", o = "right"), u && r.default(u).hasClass("active")) this._isSliding = !1;
                else if (!this._triggerSlideEvent(u, o).isDefaultPrevented() && a && u) {
                    this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(u), this._activeElement = u;
                    ...
                    if (r.default(this._element).hasClass("slide")) {
                        r.default(u).addClass(n), c.reflow(u), r.default(a).addClass(i), r.default(u).addClass(i);
                        var f = c.getTransitionDurationFromElement(a);
                        r.default(a).one(c.TRANSITION_END, function() {
                            r.default(u).removeClass(i + " " + n).addClass("active"), r.default(a).removeClass("active " + n + " " + i), s._isSliding = !1, setTimeout(function() {
                                return r.default(s._element).trigger(p)
                            }, 0)
                        }).emulateTransitionEnd(f)
                    } else r.default(a).removeClass("active"), r.default(u).addClass("active"), this._isSliding = !1, r.default(this._element).trigger(p);
                    h && this.cycle()
                }
            }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    var i = r.default(this).data("bs.carousel"),
                        n = l({}, y, r.default(this).data());
                    "object" == typeof e && (n = l({}, n, e));
                    var o = "string" == typeof e ? e : n.slide;
                    if (i || (i = new t(this, n), r.default(this).data("bs.carousel", i)), "number" == typeof e) i.to(e);
                ...
                if (i) {
                    ...
                    if (n && r.default(n).hasClass("carousel")) {
                        var o = l({}, r.default(n).data(), r.default(this).data()),
                            s = this.getAttribute("data-slide-to");
                        s && (o.interval = !1), t._jQueryInterface.call(r.default(n), o), s && r.default(n).data("bs.carousel").to(s), e.preventDefault()
                    }
                }
            }, a(t, null, [{
                key: "VERSION",
    ...
    r.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", _._dataApiClickHandler), r.default(window).on("load.bs.carousel.data-api", function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, i = t.length; e < i; e++) {
            var n = r.default(t[e]);
            _._jQueryInterface.call(n, n.data())
        }
    }), r.default.fn[m] = _._jQueryInterface, r.default.fn[m].Constructor = _, r.default.fn[m].noConflict = function() {
        return r.default.fn[m] = g, _._jQueryInterface
    };
    var w = "collapse",
        T = r.default.fn[w],
        x = {
        ...
        E = function() {
            ...
            return e.toggle = function() {
                ...
                var e, i, n = this;
                if (!(this._isTransitioning || r.default(this._element).hasClass("show") || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
                        return "string" == typeof n._config.parent ? t.getAttribute("data-parent") === n._config.parent : t.classList.contains("collapse")
                    })).length && (e = null), e && (i = r.default(e).not(this._selector).data("bs.collapse")) && i._isTransitioning))) {
                    var o = r.default.Event("show.bs.collapse");
                    if (r.default(this._element).trigger(o), !o.isDefaultPrevented()) {
                        e && (t._jQueryInterface.call(r.default(e).not(this._selector), "hide"), i || r.default(e).data("bs.collapse", null));
                        ...
                        r.default(this._element).one(c.TRANSITION_END, function() {
                            r.default(n._element).removeClass("collapsing").addClass("collapse show"), n._element.style[s] = "", n.setTransitioning(!1), r.default(n._element).trigger("shown.bs.collapse")
                ...
                if (!this._isTransitioning && r.default(this._element).hasClass("show")) {
                    ...
                    if (r.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", c.reflow(this._element), r.default(this._element).addClass("collapsing").removeClass("collapse show");
                        ...
                        r.default(this._element).one(c.TRANSITION_END, function() {
                            t.setTransitioning(!1), r.default(t._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
                ...
                return (t = l({}, x, t)).toggle = Boolean(t.toggle), c.typeCheckConfig(w, t, P), t
                ...
                return r.default(o).each(function(e, n) {
                    i._addAriaAndCollapsedClass(t._getTargetFromElement(n), [n])
                }), e
            }, e._addAriaAndCollapsedClass = function(t, e) {
                var i = r.default(t).hasClass("show");
                e.length && r.default(e).toggleClass("collapsed", !i).attr("aria-expanded", i)
                ...
                return this.each(function() {
                    var i = r.default(this),
                        ...
                        o = l({}, x, i.data(), "object" == typeof e && e ? e : {});
                    if (!n && o.toggle && "string" == typeof e && /show|hide/.test(e) && (o.toggle = !1), n || (n = new t(this, o), i.data("bs.collapse", n)), "string" == typeof e) {
    ...
    r.default(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(t) {
    ...
    }), r.default.fn[w] = E._jQueryInterface, r.default.fn[w].Constructor = E, r.default.fn[w].noConflict = function() {
        return r.default.fn[w] = T, E._jQueryInterface
    };
    var C = "dropdown",
        S = r.default.fn[C],
        ...
        I = function() {
            ...
            return e.toggle = function() {
                ...
                if (void 0 === e && (e = !1), !(this._element.disabled || r.default(this._element).hasClass("disabled") || r.default(this._menu).hasClass("show"))) {
                    ...
                    if (r.default(s).trigger(n), !n.isDefaultPrevented()) {
                        if (!this._inNavbar && e) {
                            if (void 0 === o.default) throw new TypeError("Bootstrap's dropdowns require Popper (https://popper.js.org)");
                            var a = this._element;
                            "parent" === this._config.reference ? a = s : c.isElement(this._config.reference) && (a = this._config.reference, void 0 !== this._config.reference.jquery && (a = this._config.reference[0])), "scrollParent" !== this._config.boundary && r.default(s).addClass("position-static"), this._popper = new o.default(a, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === r.default(s).closest(".navbar-nav").length && r.default(document.body).children().on("mouseover", null, r.default.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), r.default(this._menu).toggleClass("show"), r.default(s).toggleClass("show").trigger(r.default.Event("shown.bs.dropdown", i))
                    }
                }
            }, e.hide = function() {
                ...
                return t = l({}, this.constructor.Default, r.default(this._element).data(), t), c.typeCheckConfig(C, t, this.constructor.DefaultType), t
                ...
                return this.each(function() {
                    ...
                    if (i || (i = new t(this, "object" == typeof e ? e : null), r.default(this).data("bs.dropdown", i)), "string" == typeof e) {
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                    for (var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), n = 0, o = i.length; n < o; n++) {
                        var s = t._getParentFromElement(i[n]),
                            a = r.default(i[n]).data("bs.dropdown"),
                            l = {
                                relatedTarget: i[n]
                            };
                ...
                if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || r.default(e.target).closest(".dropdown-menu").length) : !j.test(e.which)) && !this.disabled && !r.default(this).hasClass("disabled")) {
    ...
    r.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', I._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", I._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", I._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(t) {
        t.preventDefault(), t.stopPropagation(), I._jQueryInterface.call(r.default(this), "toggle")
    }).on("click.bs.dropdown.data-api", ".dropdown form", function(t) {
        t.stopPropagation()
    }), r.default.fn[C] = I._jQueryInterface, r.default.fn[C].Constructor = I, r.default.fn[C].noConflict = function() {
        return r.default.fn[C] = S, I._jQueryInterface
    };
        ...
        z = function() {
            ...
            return e.toggle = function(t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var i = r.default.Event("show.bs.modal", {
                        relatedTarget: t
                    });
                    r.default(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), r.default(this._element).on("click.dismiss.bs.modal", '[data-dismiss="modal"]', function(t) {
                        return e.hide(t)
                ...
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (r.default(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        this._isShown = !1;
                        var n = r.default(this._element).hasClass("fade");
                        if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), r.default(document).off("focusin.bs.modal"), r.default(this._element).removeClass("show"), r.default(this._element).off("click.dismiss.bs.modal"), r.default(this._dialog).off("mousedown.dismiss.bs.modal"), n) {
                ...
                [window, this._element, this._dialog].forEach(function(t) {
                    return r.default(t).off(".bs.modal")
                ...
                return t = l({}, A, t), c.typeCheckConfig("modal", t, Q), t
                ...
                if (r.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    r.default(this._element).off(c.TRANSITION_END), r.default(this._element).one(c.TRANSITION_END, function() {
                        t._element.classList.remove("modal-static"), i || r.default(t._element).one(c.TRANSITION_END, function() {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), r.default(this._dialog).hasClass("modal-dialog-scrollable") && n ? n.scrollTop = 0 : this._element.scrollTop = 0, i && c.reflow(this._element), r.default(this._element).addClass("show"), this._config.focus && this._enforceFocus();
                ...
                var t = this;
                r.default(document).off("focusin.bs.modal").on("focusin.bs.modal", function(e) {
                    document !== e.target && t._element !== e.target && 0 === r.default(t._element).has(e.target).length && t._element.focus()
                })
            }, e._setEscapeEvent = function() {
                var t = this;
                this._isShown ? r.default(this._element).on("keydown.dismiss.bs.modal", function(e) {
                    t._config.keyboard && 27 === e.which ? (e.preventDefault(), t.hide()) : t._config.keyboard || 27 !== e.which || t._triggerBackdropTransition()
                }) : this._isShown || r.default(this._element).off("keydown.dismiss.bs.modal")
            }, e._setResizeEvent = function() {
                var t = this;
                this._isShown ? r.default(window).on("resize.bs.modal", function(e) {
                    return t.handleUpdate(e)
                }) : r.default(window).off("resize.bs.modal")
            }, e._hideModal = function() {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._showBackdrop(function() {
                    r.default(document.body).removeClass("modal-open"), t._resetAdjustments(), t._resetScrollbar(), r.default(t._element).trigger("hidden.bs.modal")
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), r.default(this._backdrop).appendTo(document.body), r.default(this._element).on("click.dismiss.bs.modal", function(t) {
                            e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._triggerBackdropTransition() : e.hide())
                        }), i && c.reflow(this._backdrop), r.default(this._backdrop).addClass("show"), !t) return;
                    if (!i) return void t();
                    var n = c.getTransitionDurationFromElement(this._backdrop);
                    r.default(this._backdrop).one(c.TRANSITION_END, t).emulateTransitionEnd(n)
                ...
                if (this._isBodyOverflowing) {
                    ...
                    r.default(e).each(function(e, i) {
                        var n = i.style.paddingRight,
                            o = r.default(i).css("padding-right");
                        r.default(i).data("padding-right", n).css("padding-right", parseFloat(o) + t._scrollbarWidth + "px")
                    }), r.default(i).each(function(e, i) {
                        var n = i.style.marginRight,
                            o = r.default(i).css("margin-right");
                        r.default(i).data("margin-right", n).css("margin-right", parseFloat(o) - t._scrollbarWidth + "px")
                    });
                ...
                r.default(t).each(function(t, e) {
                    var i = r.default(e).data("padding-right");
                    r.default(e).removeData("padding-right"), e.style.paddingRight = i || ""
                });
                var e = [].slice.call(document.querySelectorAll(".sticky-top"));
                r.default(e).each(function(t, e) {
                    var i = r.default(e).data("margin-right");
                    void 0 !== i && r.default(e).css("margin-right", i).removeData("margin-right")
                });
                ...
                return this.each(function() {
                    var n = r.default(this).data("bs.modal"),
                        o = l({}, A, r.default(this).data(), "object" == typeof e && e ? e : {});
                    if (n || (n = new t(this, o), r.default(this).data("bs.modal", n)), "string" == typeof e) {
                        if (void 0 === n[e]) throw new TypeError('No method named "' + e + '"');
                        n[e](i)
    ...
    r.default(document).on("click.bs.modal.data-api", '[data-toggle="modal"]', function(t) {
        ...
        var o = r.default(e).data("bs.modal") ? "toggle" : l({}, r.default(e).data(), r.default(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
        var s = r.default(e).one("show.bs.modal", function(t) {
            t.isDefaultPrevented() || s.one("hidden.bs.modal", function() {
                r.default(i).is(":visible") && i.focus()
            })
        });
        z._jQueryInterface.call(r.default(e), o, this)
    }), r.default.fn.modal = z._jQueryInterface, r.default.fn.modal.Constructor = z, r.default.fn.modal.noConflict = function() {
        return r.default.fn.modal = O, z._jQueryInterface
    };
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), o = [].slice.call(n.body.querySelectorAll("*")), s = function(t, i) {
                ...
                a.forEach(function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(i)) return -1 === D.indexOf(i) || Boolean(t.nodeValue.match(L) || t.nodeValue.match(M));
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        var e = this.constructor.DATA_KEY,
                            i = r.default(t.currentTarget).data(e);
                        i || (i = new this.constructor(t.currentTarget, this._getDelegateConfig()), r.default(t.currentTarget).data(e, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var h = function() {
                        ...
                        var e = t._hoverState;
                        t._hoverState = null, r.default(t.element).trigger(t.constructor.Event.SHOWN), "out" === e && t._leave(null, t)
                    };
                    if (r.default(this.tip).hasClass("fade")) {
                        var p = c.getTransitionDurationFromElement(this.tip);
                        r.default(this.tip).one(c.TRANSITION_END, h).emulateTransitionEnd(p)
                    } else h()
                }
            }, e.hide = function(t) {
                var e = this,
                    i = this.getTipElement(),
                    n = r.default.Event(this.constructor.Event.HIDE),
                    o = function() {
                        "show" !== e._hoverState && i.parentNode && i.parentNode.removeChild(i), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), r.default(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t()
                    };
                if (r.default(this.element).trigger(n), !n.isDefaultPrevented()) {
                    if (r.default(i).removeClass("show"), "ontouchstart" in document.documentElement && r.default(document.body).children().off("mouseover", null, r.default.noop), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1, r.default(this.tip).hasClass("fade")) {
                ...
                this.setElementContent(r.default(t.querySelectorAll(".tooltip-inner")), this.getTitle()), r.default(t).removeClass("fade show")
            }, e.setElementContent = function(t, e) {
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = R(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? r.default(e).parent().is(t) || t.empty().append(e) : t.text(r.default(e).text())
            }, e.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) r.default(t.element).on(t.constructor.Event.CLICK, t.config.selector, function(e) {
                        ...
                        r.default(t.element).on(i, t.config.selector, function(e) {
                            return t._enter(e)
                ...
                return Object.keys(e).forEach(function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), c.typeCheckConfig(F, t, this.constructor.DefaultType), t.sanitize && (t.template = R(t.template, t.whiteList, t.sanitizeFn)), t
                ...
                null === t.getAttribute("x-placement") && (r.default(t).removeClass("fade"), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
            }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    var i = r.default(this),
                        n = i.data("bs.tooltip"),
                        o = "object" == typeof e && e;
                    if ((n || !/dispose|hide/.test(e)) && (n || (n = new t(this, o), i.data("bs.tooltip", n)), "string" == typeof e)) {
                        if (void 0 === n[e]) throw new TypeError('No method named "' + e + '"');
                        n[e]()
                    }
                })
    ...
    r.default.fn[F] = U._jQueryInterface, r.default.fn[F].Constructor = U, r.default.fn[F].noConflict = function() {
        return r.default.fn[F] = B, U._jQueryInterface
    };
    var X = "popover",
        G = r.default.fn[X],
        ...
        et = function(t) {
            ...
            return o.isWithContent = function() {
                ...
                return this.each(function() {
                    var e = r.default(this).data("bs.popover"),
                        i = "object" == typeof t ? t : null;
                    if ((e || !/dispose|hide/.test(t)) && (e || (e = new n(this, i), r.default(this).data("bs.popover", e)), "string" == typeof t)) {
    ...
    r.default.fn[X] = et._jQueryInterface, r.default.fn[X].Constructor = et, r.default.fn[X].noConflict = function() {
        return r.default.fn[X] = G, et._jQueryInterface
    };
    var it = "scrollspy",
        nt = r.default.fn[it],
        rt = {
        ...
        st = function() {
            function t(t, e) {
                var i = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " .nav-link," + this._config.target + " .list-group-item," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, r.default(this._scrollElement).on("scroll.bs.scrollspy", function(t) {
                    return i._process(t)
            ...
            return e.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                    ...
                    if (o && (e = document.querySelector(o)), e) {
                        ...
                        if (s.width || s.height) return [r.default(e)[i]().top + n, o]
                    }
                    return null
                }).filter(function(t) {
                    return t
                ...
                if ("string" != typeof(t = l({}, rt, "object" == typeof t && t ? t : {})).target && c.isElement(t.target)) {
                    var e = r.default(t.target).attr("id");
                    e || (e = c.getUID(it), r.default(t.target).attr("id", e)), t.target = "#" + e
                }
                return c.typeCheckConfig(it, t, ot), t
                ...
                var e = this._selector.split(",").map(function(e) {
                    ...
                    i = r.default([].slice.call(document.querySelectorAll(e.join(","))));
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass("active"), i.addClass("active")) : (i.addClass("active"), i.parents(".nav, .list-group").prev(".nav-link, .list-group-item").addClass("active"), i.parents(".nav, .list-group").prev(".nav-item").children(".nav-link").addClass("active")), r.default(this._scrollElement).trigger("activate.bs.scrollspy", {
                    relatedTarget: t
                })
            }, e._clear = function() {
                ...
                return this.each(function() {
                    ...
                    if (i || (i = new t(this, "object" == typeof e && e), r.default(this).data("bs.scrollspy", i)), "string" == typeof e) {
                        if (void 0 === i[e]) throw new TypeError('No method named "' + e + '"');
                        i[e]()
                    }
                })
    ...
    }), r.default.fn[it] = st._jQueryInterface, r.default.fn[it].Constructor = st, r.default.fn[it].noConflict = function() {
        return r.default.fn[it] = nt, st._jQueryInterface
    };
    var at = r.default.fn.tab,
        lt = function() {
            function t(t) {
                this._element = t
            }
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass("active") || r.default(this._element).hasClass("disabled"))) {
                    var e, i, n = r.default(this._element).closest(".nav, .list-group")[0],
                    ...
                    if (i && r.default(i).trigger(a), r.default(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented()) {
                        ...
                        var u = function() {
                            var e = r.default.Event("hidden.bs.tab", {
                                ...
                                n = r.default.Event("shown.bs.tab", {
                                    relatedTarget: i
                                });
                            r.default(i).trigger(e), r.default(t._element).trigger(n)
                        };
                ...
                var n = this,
                    o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? r.default(e).children(".active") : r.default(e).find("> li > .active"))[0],
                    s = i && o && r.default(o).hasClass("fade"),
                    a = function() {
                        return n._transitionComplete(t, o, i)
                    };
                if (o && s) {
                    var l = c.getTransitionDurationFromElement(o);
                    r.default(o).removeClass("show").one(c.TRANSITION_END, a).emulateTransitionEnd(l)
                } else a()
            }, e._transitionComplete = function(t, e, i) {
                if (e) {
                    r.default(e).removeClass("active");
                    var n = r.default(e.parentNode).find("> .dropdown-menu .active")[0];
                    n && r.default(n).removeClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (r.default(t).addClass("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), c.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && r.default(t.parentNode).hasClass("dropdown-menu")) {
                    var o = r.default(t).closest(".dropdown")[0];
                    if (o) {
    ...
    r.default(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(), lt._jQueryInterface.call(r.default(this), "show")
    }), r.default.fn.tab = lt._jQueryInterface, r.default.fn.tab.Constructor = lt, r.default.fn.tab.noConflict = function() {
        return r.default.fn.tab = at, lt._jQueryInterface
    };
    var ct = r.default.fn.toast,
        ut = {
            animation: "boolean",
            autohide: "boolean",
            delay: "number"
        ...
        ht = function() {
            ...
            return e.show = function() {
                ...
                if (r.default(this._element).trigger(e), !e.isDefaultPrevented()) {
                    ...
                    var i = function() {
                        t._element.classList.remove("showing"), t._element.classList.add("show"), r.default(t._element).trigger("shown.bs.toast"), t._config.autohide && (t._timeout = setTimeout(function() {
                            t.hide()
                        }, t._config.delay))
                    };
                ...
                return t = l({}, dt, r.default(this._element).data(), "object" == typeof t && t ? t : {}), c.typeCheckConfig("toast", t, this.constructor.DefaultType), t
            }, e._setListeners = function() {
                var t = this;
                ...
                var t = this,
                    e = function() {
                        t._element.classList.add("hide"), r.default(t._element).trigger("hidden.bs.toast")
                    };
                if (this._element.classList.remove("show"), this._config.animation) {
                    var i = c.getTransitionDurationFromElement(this._element);
                    r.default(this._element).one(c.TRANSITION_END, e).emulateTransitionEnd(i)
                } else e()
    ...
    r.default.fn.toast = ht._jQueryInterface, r.default.fn.toast.Constructor = ht, r.default.fn.toast.noConflict = function() {
        return r.default.fn.toast = ct, ht._jQueryInterface
    }, t.Alert = h, t.Button = f, t.Carousel = _, t.Collapse = E, t.Dropdown = I, t.Modal = z, t.Popover = et, t.Scrollspy = st, t.Tab = lt, t.Toast = ht, t.Tooltip = U, t.Util = c, Object.defineProperty(t, "__esModule", {
        value: !0
    })
});
var PageTransitions = function() {
    var t, e, i = $("#main").children(".pt-page"),
        n = $(".nav-menu .pt-link"),
        r = 1,
        o = (i.length, 0),
        s = !1,
    ...
    function h() {
        ...
        }), i.eq(o).addClass("page-active"), n.length > 0 && (window.onhashchange = function() {
            var t = location.hash,
                e = [];
            n.each(function() {
                e.push($(this).attr("href"))
            }), e.indexOf(t) >= 0 && ($nextPageIndex = $(t).index(), r > 67 && (r = 1), n.removeClass("active"), n.eq(e.indexOf(t)).addClass("active"), function(t) {
                var e, n, h = $("html").data("randomAnimation"),
                    f = $("html").data("animation");
                if (o === t) return !1;
                if (s = !0, !h) switch (f) {
                    case 1:
                        e = 1, n = 2;
                ...
                h ? d = r : o < t ? d = e : o > t && (d = n);
                var m = i.eq(o);
                o = t;
                var g = i.eq(o).addClass("page-active"),
                    y = "",
                    v = "";
                switch (d) {
                    case 1:
                        y = "pt-page-moveToLeft", v = "pt-page-moveFromRight";
                        break;
                    case 2:
                        y = "pt-page-moveToRight", v = "pt-page-moveFromLeft";
                        break;
                    case 3:
                        y = "pt-page-moveToTop", v = "pt-page-moveFromBottom";
                        break;
                    case 4:
                        y = "pt-page-moveToBottom", v = "pt-page-moveFromTop";
                        break;
                    case 5:
                        y = "pt-page-fade", v = "pt-page-moveFromRight pt-page-ontop";
                        break;
                    case 6:
                        y = "pt-page-fade", v = "pt-page-moveFromLeft pt-page-ontop";
                        break;
                    case 7:
                        y = "pt-page-fade", v = "pt-page-moveFromBottom pt-page-ontop";
                        break;
                    case 8:
                        y = "pt-page-fade", v = "pt-page-moveFromTop pt-page-ontop";
                        break;
                    case 9:
                        y = "pt-page-moveToLeftFade", v = "pt-page-moveFromRightFade";
                        break;
                    case 10:
                        y = "pt-page-moveToRightFade", v = "pt-page-moveFromLeftFade";
                        break;
                    case 11:
                        y = "pt-page-moveToTopFade", v = "pt-page-moveFromBottomFade";
                        break;
                    case 12:
                        y = "pt-page-moveToBottomFade", v = "pt-page-moveFromTopFade";
                        break;
                    case 13:
                        y = "pt-page-moveToLeftEasing pt-page-ontop", v = "pt-page-moveFromRight";
                        break;
                    case 14:
                        y = "pt-page-moveToRightEasing pt-page-ontop", v = "pt-page-moveFromLeft";
                        break;
                    case 15:
                        y = "pt-page-moveToTopEasing pt-page-ontop", v = "pt-page-moveFromBottom";
                        break;
                    case 16:
                        y = "pt-page-moveToBottomEasing pt-page-ontop", v = "pt-page-moveFromTop";
                        break;
                    case 17:
                        y = "pt-page-scaleDown", v = "pt-page-moveFromRight pt-page-ontop";
                        break;
                    case 18:
                        y = "pt-page-scaleDown", v = "pt-page-moveFromLeft pt-page-ontop";
                        break;
                    case 19:
                        y = "pt-page-scaleDown", v = "pt-page-moveFromBottom pt-page-ontop";
                        break;
                    case 20:
                        y = "pt-page-scaleDown", v = "pt-page-moveFromTop pt-page-ontop";
                        break;
                    case 21:
                        y = "pt-page-scaleDown", v = "pt-page-scaleUpDown pt-page-delay300";
                        break;
                    case 22:
                        y = "pt-page-scaleDownUp", v = "pt-page-scaleUp pt-page-delay300";
                        break;
                    case 23:
                        y = "pt-page-moveToLeft pt-page-ontop", v = "pt-page-scaleUp";
                        break;
                    case 24:
                        y = "pt-page-moveToRight pt-page-ontop", v = "pt-page-scaleUp";
                        break;
                    case 25:
                        y = "pt-page-moveToTop pt-page-ontop", v = "pt-page-scaleUp";
                        break;
                    case 26:
                        y = "pt-page-moveToBottom pt-page-ontop", v = "pt-page-scaleUp";
                        break;
                    case 27:
                        y = "pt-page-scaleDownCenter", v = "pt-page-scaleUpCenter pt-page-delay400";
                        break;
                    case 28:
                        y = "pt-page-rotateRightSideFirst", v = "pt-page-moveFromRight pt-page-delay200 pt-page-ontop";
                        break;
                    case 29:
                        y = "pt-page-rotateLeftSideFirst", v = "pt-page-moveFromLeft pt-page-delay200 pt-page-ontop";
                        break;
                    case 30:
                        y = "pt-page-rotateTopSideFirst", v = "pt-page-moveFromTop pt-page-delay200 pt-page-ontop";
                        break;
                    case 31:
                        y = "pt-page-rotateBottomSideFirst", v = "pt-page-moveFromBottom pt-page-delay200 pt-page-ontop";
                        break;
                    case 32:
                        y = "pt-page-flipOutRight", v = "pt-page-flipInLeft pt-page-delay500";
                        break;
                    case 33:
                        y = "pt-page-flipOutLeft", v = "pt-page-flipInRight pt-page-delay500";
                        break;
                    case 34:
                        y = "pt-page-flipOutTop", v = "pt-page-flipInBottom pt-page-delay500";
                        break;
                    case 35:
                        y = "pt-page-flipOutBottom", v = "pt-page-flipInTop pt-page-delay500";
                        break;
                    case 36:
                        y = "pt-page-rotateFall pt-page-ontop", v = "pt-page-scaleUp";
                        break;
                    case 37:
                        y = "pt-page-rotateOutNewspaper", v = "pt-page-rotateInNewspaper pt-page-delay500";
                        break;
                    case 38:
                        y = "pt-page-rotatePushLeft", v = "pt-page-moveFromRight";
                        break;
                    case 39:
                        y = "pt-page-rotatePushRight", v = "pt-page-moveFromLeft pt-page-ontop";
                        break;
                    case 40:
                        y = "pt-page-rotatePushTop ", v = "pt-page-moveFromBottom";
                        break;
                    case 41:
                        y = "pt-page-rotatePushBottom ", v = "pt-page-moveFromTop pt-page-ontop";
                        break;
                    case 42:
                        y = "pt-page-rotatePushLeft", v = "pt-page-rotatePullRight pt-page-delay180";
                        break;
                    case 43:
                        y = "pt-page-rotatePushRight", v = "pt-page-rotatePullLeft pt-page-delay180";
                        break;
                    case 44:
                        y = "pt-page-rotatePushTop", v = "pt-page-rotatePullBottom pt-page-delay180";
                        break;
                    case 45:
                        y = "pt-page-rotatePushBottom", v = "pt-page-rotatePullTop pt-page-delay180";
                        break;
                    case 46:
                        y = "pt-page-rotateFoldLeft", v = "pt-page-moveFromRightFade";
                        break;
                    case 47:
                        y = "pt-page-rotateFoldRight", v = "pt-page-moveFromLeftFade";
                        break;
                    case 48:
                        y = "pt-page-rotateFoldTop", v = "pt-page-moveFromBottomFade";
                        break;
                    case 49:
                        y = "pt-page-rotateFoldBottom", v = "pt-page-moveFromTopFade";
                        break;
                    case 50:
                        y = "pt-page-moveToRightFade", v = "pt-page-rotateUnfoldLeft";
                        break;
                    case 51:
                        y = "pt-page-moveToLeftFade", v = "pt-page-rotateUnfoldRight";
                        break;
                    case 52:
                        y = "pt-page-moveToBottomFade", v = "pt-page-rotateUnfoldTop";
                        break;
                    case 53:
                        y = "pt-page-moveToTopFade", v = "pt-page-rotateUnfoldBottom";
                        break;
                    case 54:
                        y = "pt-page-rotateRoomLeftOut pt-page-ontop", v = "pt-page-rotateRoomLeftIn";
                        break;
                    case 55:
                        y = "pt-page-rotateRoomRightOut pt-page-ontop", v = "pt-page-rotateRoomRightIn";
                        break;
                    case 56:
                        y = "pt-page-rotateRoomTopOut pt-page-ontop", v = "pt-page-rotateRoomTopIn";
                        break;
                    case 57:
                        y = "pt-page-rotateRoomBottomOut pt-page-ontop", v = "pt-page-rotateRoomBottomIn";
                        break;
                    case 58:
                        y = "pt-page-rotateCubeLeftOut pt-page-ontop", v = "pt-page-rotateCubeLeftIn";
                        break;
                    case 59:
                        y = "pt-page-rotateCubeRightOut pt-page-ontop", v = "pt-page-rotateCubeRightIn";
                        break;
                    case 60:
                        y = "pt-page-rotateCubeTopOut pt-page-ontop", v = "pt-page-rotateCubeTopIn";
                        break;
                    case 61:
                        y = "pt-page-rotateCubeBottomOut pt-page-ontop", v = "pt-page-rotateCubeBottomIn";
                        break;
                    case 62:
                        y = "pt-page-rotateCarouselLeftOut pt-page-ontop", v = "pt-page-rotateCarouselLeftIn";
                        break;
                    case 63:
                        y = "pt-page-rotateCarouselRightOut pt-page-ontop", v = "pt-page-rotateCarouselRightIn";
                        break;
                    case 64:
                        y = "pt-page-rotateCarouselTopOut pt-page-ontop", v = "pt-page-rotateCarouselTopIn";
                        break;
                    case 65:
                        y = "pt-page-rotateCarouselBottomOut pt-page-ontop", v = "pt-page-rotateCarouselBottomIn";
                        break;
                    case 66:
                        y = "pt-page-rotateSidesOut", v = "pt-page-rotateSidesIn pt-page-delay200";
                        break;
                    case 67:
                        y = "pt-page-rotateSlideOutToLeft", v = "pt-page-rotateSlideInFromRight";
                        break;
                    case 68:
                        y = "pt-page-rotateSlideOutToRight", v = "pt-page-rotateSlideInFromLeft"
                }
                m.addClass(y).on(c, function() {
                    m.off(c), a = !0, l && p(m, g)
    ...
    function p(t, e) {
        var i, n;
        a = !1, l = !1, n = e, (i = t).attr("class", i.data("originalClassList")), n.attr("class", n.data("originalClassList") + " page-active"), s = !1
    }
    return t = [], e = location.hash, n.each(function() {
        t.push($(this).attr("href"))
    }), t.indexOf(e) >= 0 && (o = t.indexOf(e), n.removeClass("active"), n.eq(t.indexOf(e)).addClass("active")), h(), {
        init: h
    }
}();
jQuery(document).ready(function(t) {
        ...
        function p(e) {
            ...
            if (e.parents(".cd-headline").hasClass("type")) {
                ...
                ! function e(i, n, o, s) {
                    if (i.removeClass("in").addClass("out"), i.is(":last-child") ? o && setTimeout(function() {
                            p(g(n))
                        }, r) : setTimeout(function() {
                            e(i.next(), n, o, s)
                        }, s), i.is(":last-child") && t("html").hasClass("no-csstransitions")) {
                        var a = g(n);
                        y(n, a)
                    }
                }(e.find("i").eq(0), e, h, a), m(i.find("i").eq(0), i, h, a)
            } else e.parents(".cd-headline").hasClass("clip") ? e.parents(".cd-words-wrapper").animate({
                width: "2px"
            }, d, function() {
                y(e, i), f(i)
            }) : e.parents(".cd-headline").hasClass("loading-bar") ? (e.parents(".cd-words-wrapper").removeClass("is-loading"), y(e, i), setTimeout(function() {
                p(i)
            }, o), setTimeout(function() {
                e.parents(".cd-words-wrapper").addClass("is-loading")
            }, s)) : (y(e, i), setTimeout(function() {
                p(i)
            }, r))
        }
        ...
        t(".cd-headline.letters").find("b").each(function() {
            var e = t(this),
                n = e.text().split(""),
        ...
        }), e = t(".cd-headline"), n = r, e.each(function() {
            var e = t(this);
            if (e.hasClass("loading-bar")) n = o, setTimeout(function() {
    ...
    function(t, e) {
        if ("function" == typeof define && define.amd) define(["module", "exports"], e);
            ...
            e(i, i.exports), t.fitty = i.exports
        }
    }(this, function(t, e) {
        "use strict";
        ...
        e.default = function(t) {
            ...
            function n(t) {
                ...
                return "string" == typeof t ? e(r(document.querySelectorAll(t)), i) : e([t], i)[0]
            }
            if (t) {
                var r = function(t) {
                        return [].slice.call(t)
                    ...
                    s = [],
                    a = null,
                    l = "requestAnimationFrame" in t ? function() {
                        t.cancelAnimationFrame(a), a = t.requestAnimationFrame(function() {
                    ...
                    u = function(t) {
                        t.filter(function(t) {
                            ...
                            t.styleComputed = p(t)
                        }), t.filter(f).forEach(g), t.filter(h).forEach(d), t.forEach(m), t.forEach(y)
                    },
                    d = function(t) {
                        t.availableWidth = t.element.parentNode.clientWidth, t.currentWidth = t.element.scrollWidth, t.previousFontSize = t.currentFontSize, t.currentFontSize = Math.min(Math.max(t.minSize, t.availableWidth / t.currentWidth * t.previousFontSize), t.maxSize), t.whiteSpace = t.multiLine && t.currentFontSize === t.minSize ? "normal" : "nowrap"
                    },
                    h = function(t) {
                        return t.dirty !== o.DIRTY_LAYOUT || t.dirty === o.DIRTY_LAYOUT && t.element.parentNode.clientWidth !== t.availableWidth
                    },
                    p = function(e) {
                        var i = t.getComputedStyle(e.element, null);
                        e.currentFontSize = parseInt(i.getPropertyValue("font-size"), 10), e.display = i.getPropertyValue("display"), e.whiteSpace = i.getPropertyValue("white-space")
                    },
                    f = function(t) {
                        var e = !1;
                        return /inline-/.test(t.display) || (e = !0, t.display = "inline-block"), "nowrap" !== t.whiteSpace && (e = !0, t.whiteSpace = "nowrap"), e
                    },
                    m = function(t) {
                        g(t), t.dirty = o.IDLE
                    },
                    g = function(t) {
                        t.originalStyle || (t.originalStyle = t.element.getAttribute("style") || ""), t.element.style.cssText = t.originalStyle + ";white-space:" + t.whiteSpace + ";display:" + t.display + ";font-size:" + t.currentFontSize + "px"
                    },
                    y = function(t) {
                        t.element.dispatchEvent(new CustomEvent("fit", {
                            detail: {
                    ...
                    w = function(t) {
                        t.observeMutations && (t.observer = new MutationObserver(v(t, o.DIRTY_CONTENT)), t.observer.observe(t.element, t.observeMutations))
                    },
                    T = {
                        minSize: 16,
                        maxSize: 512,
                    ...
                    x = null,
                    P = function() {
                        t.clearTimeout(x), x = t.setTimeout(c(o.DIRTY_LAYOUT), n.observeWindowDelay)
                    },
                    E = ["resize", "orientationchange"];
                return Object.defineProperty(n, "observeWindow", {
                    set: function(e) {
                ...
                }), n.observeWindow = !0, n.observeWindowDelay = 100, n.fitAll = c(o.DIRTY), n
            }
        }("undefined" == typeof window ? null : window), t.exports = e.default
    }),
    function(t) {
        function e() {}
        ...
        n.getListeners = function(t) {
            ...
            for (r in o)
                if (o.hasOwnProperty(r))
                    for (n = o[r].length; n--;) !0 === (i = o[r][n]).once && this.removeListener(t, i.listener), i.listener.apply(this, e || []) === this._getOnceReturnValue() && this.removeListener(t, i.listener);
            return this
        ...
        function n(e) {
            ...
            return function(u) {
                if (function() {
                    ...
                    var h = {};
                    h.width = u.offsetWidth, h.height = u.offsetHeight;
                    for (var p = h.isBorderBox = !(!a || !d[a] || "border-box" !== d[a]), f = 0, m = o.length; m > f; f++) {
                        var g = o[f],
                            y = d[g];
                        y = n(u, y);
                        var v = parseFloat(y);
                    ...
                    var b = h.paddingLeft + h.paddingRight,
                        _ = h.paddingTop + h.paddingBottom,
                        w = h.marginLeft + h.marginRight,
                        T = h.marginTop + h.marginBottom,
                        x = h.borderLeftWidth + h.borderRightWidth,
                        P = h.borderTopWidth + h.borderBottomWidth,
                        E = p && l,
                        C = i(d.width);
                    !1 !== C && (h.width = C + (E ? 0 : b + x));
                    var S = i(d.height);
                    return !1 !== S && (h.height = S + (E ? 0 : _ + P)), h.innerWidth = h.width - (b + x), h.innerHeight = h.height - (_ + P), h.outerWidth = h.width + w, h.outerHeight = h.height + T, h
                }
            }
        }
    ...
    function(t, e) {
        ...
        n.isArray = function(t) {
            ...
            for (var r = [], o = 0, s = (t = n.makeArray(t)).length; s > o; o++) {
                var a = t[o];
                if (n.isElement(a))
                    if (e) {
                        i(a, e) && r.push(a);
                        for (var l = a.querySelectorAll(e), c = 0, u = l.length; u > c; c++) r.push(l[c])
                    } else r.push(a)
            }
            return r
        ...
        return n.htmlInit = function(i, r) {
            e(function() {
                for (var e = n.toDashed(r), s = document.querySelectorAll(".js-" + e), a = "data-" + e + "-options", l = 0, c = s.length; c > l; l++) {
                    var u, d = s[l],
                        h = d.getAttribute(a);
                    try {
                        u = h && JSON.parse(h)
    ...
    function(t, e) {
        ...
        r.extend(o.prototype, e.prototype), o.prototype._create = function() {
            ...
            var t = a(this.element),
                ...
                o = t[n ? "top" : "bottom"],
                s = this.layout.size,
                l = -1 != r.indexOf("%") ? parseFloat(r) / 100 * s.width : parseInt(r, 10),
                c = -1 != o.indexOf("%") ? parseFloat(o) / 100 * s.height : parseInt(o, 10);
            l = isNaN(l) ? 0 : l, c = isNaN(c) ? 0 : c, l -= i ? s.paddingLeft : s.paddingRight, c -= n ? s.paddingTop : s.paddingBottom, this.position.x = l, this.position.y = c
        ...
        }, o.prototype.moveTo = u ? o.prototype._transitionTo : o.prototype.goTo, o.prototype.setPosition = function(t, e) {
    ...
    function(t, e) {
        ...
        return s.namespace = "outlayer", s.Item = o, s.defaults = {
            ...
            var r = this,
                o = e.length;
            if (e && o)
                for (var s = 0, a = 0, l = e.length; l > a; a++) e[a].once(t, n);
            else i()
            ...
            for (var e = [], i = 0, n = (t = r.makeArray(t)).length; n > i; i++) {
                var o = t[i],
                    s = this.getItem(o);
                s && e.push(s)
            }
    ...
    function(t, e) {
        ...
        return n.prototype._resetLayout = function() {
            ...
            for (var r = this._getColGroup(n), o = Math.min.apply(Math, r), s = i.indexOf(r, o), a = {
    ...
    function(t, e) {
        ...
        (function(t, e) {
            for (var i in e) t[i] = e[i]
        })(i.prototype, e.prototype), i.prototype._getElementOffset = n, i.prototype.layout = r, i.prototype._getMeasurement = o;
    ...
    function(t, e) {
        ...
        u.Item = o, u.LayoutMode = s, u.prototype._create = function() {
            ...
            for (var i = [], n = [], r = [], o = this._getFilterTest(e), s = 0, a = t.length; a > s; s++) {
                ...
                if (!l.isIgnored) {
                    var c = o(l);
                    c && i.push(l), c && l.isHidden ? n.push(l) : c || l.isHidden || r.push(l)
                }
            }
            return {
                matches: i,
        ...
        u.sortDataParsers = {
            ...
            if (i) {
                var n = [].concat.apply(i, this.sortHistory),
                    r = (t = n, e = this.options.sortAscending, function(i, n) {
                        for (var r = 0, o = t.length; o > r; r++) {
                            var s = t[r],
                                a = i.sortData[s],
                                l = n.sortData[s];
                            if (a > l || l > a) return (a > l ? 1 : -1) * ((void 0 !== e[s] ? e[s] : e) ? 1 : -1)
                        }
                        return 0
                    });
                this.filteredItems.sort(r), i != this.sortHistory[0] && this.sortHistory.unshift(i)
            }
    ...
    function(t) {
        ...
        function e(t) {
            var e = t.create("moduloColumns");
            e.prototype._resetLayout = function() {
                this.getColumnWidth(), this._getMeasurement("gutter", "outerHeight"), this.getSize();
                var t = this.options.gutter || 0,
                    e = this.size.innerWidth;
                this.columnWidth += t;
                var i = this.cols = Math.floor((e + t) / this.columnWidth) || 1;
                for (this.columnHeights = []; i--;) this.columnHeights.push(0);
                this.currentColumn = 0
            }, e.prototype._getItemLayoutPosition = function(t) {
                t.getSize();
                var e = t.size.outerWidth,
                    i = t.size.outerHeight,
                    n = Math.min(this.cols, Math.ceil(e / this.columnWidth));
                this.currentColumn + n > this.cols && (this.currentColumn = 0);
                for (var r = 0, o = 0; o < n; o++) r = Math.max(r, this.columnHeights[this.currentColumn + o]);
                var s = r + i;
                for (o = 0; o < n; o++) this.columnHeights[this.currentColumn + o] = s;
                var a = {
                    x: this.currentColumn * this.columnWidth,
                    y: r
                };
                return this.currentColumn += n, this.currentColumn > this.cols && (this.currentColumn = 0), a
            }, e.prototype._getContainerSize = function() {
                return {
        ...
        "function" == typeof define && define.amd ? define(["isotope/js/layout-mode"], e) : e(t.Isotope.LayoutMode)
    }(window),
    function(t) {
        ...
        y.prototype = {
            ...
            open: function(i) {
                ...
                if (!e.isOpen) {
                    ...
                    T("BeforeOpen"), e.st.showCloseBtn && (e.st.closeBtnInside ? (_(c, function(t, e, i, n) {
                    ...
                    return e.isIE7 && (y += " mfp-ie7"), y && e._addClassToMFP(y), e.updateItemHTML(), T("BuildControls"), t("html").css(m), e.bgOverlay.add(e.wrap).prependTo(e.st.prependTo || t(document.body)), e._lastFocusedEl = document.activeElement, setTimeout(function() {
                        e.content ? (e._addClassToMFP(f), e._setFocus()) : e.bgOverlay.addClass(f), n.on("focusin" + p, e._onFocusIn)
                    }, 16), e.isOpen = !0, e.updateSize(h), T(u), i
                }
                e.updateItemHTML()
            },
            close: function() {
            ...
            updateItemHTML: function() {
                ...
                e.appendContent(s, n), i.preloaded = !0, T(d, i), r = i.type, e.container.prepend(e.contentContainer), T("AfterChange")
            },
            ...
            parseEl: function(i) {
                ...
                return r.type = n || e.st.type || "inline", r.index = i, r.parsed = !0, e.items[i] = r, T("ElementParse", r), e.items[i]
            },
            ...
            updateStatus: function(t, n) {
                if (e.preloader) {
                    ...
                    T("UpdateStatus", r), t = r.status, n = r.text, e.preloader.html(n), e.preloader.find("a").on("click", function(t) {
            ...
            if ("string" == typeof i)
                if ("open" === i) {
                    var r, o = v ? n.data("magnificPopup") : n[0].magnificPopup,
        ...
        var E, C, S, j = "inline",
            k = function() {
                S && (C.after(S.addClass(E)).detach(), S = null)
            };
                ...
                getInline: function(i, n) {
                    if (k(), i.src) {
                        ...
                        if (o.length) {
                            ...
                            s && s.tagName && (C || (E = r.hiddenClass, C = w(E), E = "mfp-" + E), S = o.after(C).detach().removeClass(E)), e.updateStatus("ready")
        ...
        t.magnificPopup.registerModule(A, {
            ...
            proto: {
                initAjax: function() {
                    e.types.push(A), Y = e.st.ajax.cursor, _(a + "." + A, z), _("BeforeChange." + A, z)
                },
                getAjax: function(i) {
                    ...
                    var n = t.extend({
                        ...
                        success: function(n, r, o) {
                            ...
                            T("ParseAjax", s), e.appendContent(t(s.data), A), i.finished = !0, Q(), e._setFocus(), setTimeout(function() {
                                e.wrap.addClass(f)
            ...
            proto: {
                ...
                _onImageHasSize: function(t) {
                    t.img && (t.hasSize = !0, I && clearInterval(I), t.isCheckingImgSize = !1, T("ImageHasSize", t), t.imgHidden && (e.content && e.content.removeClass("mfp-loading"), t.imgHidden = !1))
                },
                    ...
                    var i = 0,
                        ...
                        r = function(o) {
                            I && clearInterval(I), I = setInterval(function() {
                                return n.naturalWidth > 0 ? void e._onImageHasSize(t) : (i > 200 && clearInterval(I), void(3 == ++i ? r(10) : 40 === i ? r(50) : 100 === i && r(500)))
                            }, o)
                        };
                    r(1)
                },
                getImage: function(i, n) {
                    var r = 0,
                        o = function() {
                            i && (i.img[0].complete ? (i.img.off(".mfploader"), i === e.currItem && (e._onImageHasSize(i), e.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, T("ImageLoadComplete")) : 200 > ++r ? setTimeout(o, 100) : s())
                        },
                        s = function() {
                    ...
                    return e.direction = !0, !(!i || !i.enabled) && (o += " mfp-gallery", _(u + r, function() {
                        ...
                        if (e.items.length > 1 && i.arrows && !e.arrowLeft) {
                            ...
                            r[a](function() {
                                ...
                                e.next()
                            }), e.isIE7 && (w("b", r[0], !1, !0), w("a", r[0], !1, !0), w("b", o[0], !1, !0), w("a", o[0], !1, !0)), e.container.append(r.add(o))
                        }
                    }), _(d + r, function() {
            ...
            proto: {
                initRetina: function() {
                    if (window.devicePixelRatio > 1) {
                        var t = e.st.retina,
                            i = t.ratio;
                        (i = isNaN(i) ? i() : i) > 1 && (_("ImageHasSize." + W, function(t, e) {
                            e.img.css({
        ...
        }), F = "ontouchstart" in window, B = function() {
            b.off("touchmove" + N + " touchend" + N)
        }, N = ".mfpFastClick", t.fn.mfpFastClick = function(e) {
            return t(this).each(function() {
                var i, n, r, o, s, a, l, c = t(this);
                F && c.on("touchstart" + N, function(t) {
                    s = !1, l = 1, a = t.originalEvent ? t.originalEvent.touches[0] : t.touches[0], r = a.clientX, o = a.clientY, b.on("touchmove" + N, function(t) {
                        a = t.originalEvent ? t.originalEvent.touches : t.touches, l = a.length, a = a[0], (Math.abs(a.clientX - r) > 10 || Math.abs(a.clientY - o) > 10) && (s = !0, B())
                    }).on("touchend" + N, function(t) {
                        B(), s || l > 1 || (i = !0, t.preventDefault(), clearTimeout(n), n = setTimeout(function() {
                            i = !1
                        }, 1e3), e())
                    })
                }), c.on("click" + N, function() {
                    i || e()
                })
            })
        }, t.fn.destroyMfpFastClick = function() {
            t(this).off("touchstart" + N + " click" + N), F && b.off("touchmove" + N + " touchend" + N)
        }, P()
    }),
    function(t, e) {
        ...
        var i, n, r, o = "object",
            ...
            P = a.document,
            E = _(P) && _(P.createElement),
            C = function(t) {
                return E ? P.createElement(t) : {}
            },
            S = !c && !l(function() {
            ...
            k = {
                f: c ? j : function(t, e) {
                    if (t = b(t), e = w(e, !0), S) try {
                        return j(t, e)
                    } catch (t) {}
                    if (x(t, e)) return p(!h.f.call(t, e), t[e])
                }
            },
            Y = function(t) {
            ...
            O = {
                f: c ? I : function(t, e, i) {
                    if (Y(t), e = w(e, !0), Y(i), S) try {
                        return I(t, e, i)
                    } catch (t) {}
            ...
            z = e(function(t) {
                var e = a["__core-js_shared__"] || Q("__core-js_shared__", {});
            ...
            D = z("native-function-to-string", Function.toString),
            L = a.WeakMap,
            M = "function" == typeof L && /native code/.test(D.call(L)),
            R = 0,
            F = Math.random(),
            B = function(t) {
                return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++R + F).toString(36)
            },
            N = z("keys"),
            W = function(t) {
                return N[t] || (N[t] = B(t))
        ...
        var K = {
                ...
                getterFor: function(t) {
                    return function(e) {
                        var i;
                        if (!_(e) || (i = n(e)).type !== t) throw TypeError("Incompatible receiver, " + t + " required");
                        return i
                    }
                }
            },
            Z = e(function(t) {
                ...
                z("inspectSource", function(t) {
                    ...
                    var s = !!o && !!o.unsafe,
                        l = !!o && !!o.enumerable,
                        c = !!o && !!o.noTargetGet;
                    "function" == typeof r && ("string" != typeof e || x(r, "name") || A(r, "name", e), i(r).source = n.join("string" == typeof e ? e : "")), t !== a ? (s ? !c && t[e] && (l = !0) : delete t[e], l ? t[e] = r : A(t, e, r)) : l ? t[e] = r : Q(e, r)
            ...
            et = function(t, e) {
                return arguments.length < 2 ? tt(J[t]) || tt(a[t]) : J[t] && J[t][e] || a[t] && a[t][e]
            },
            it = Math.ceil,
            nt = Math.floor,
            rt = function(t) {
            ...
            ot = Math.min,
            st = function(t) {
                return t > 0 ? ot(rt(t), 9007199254740991) : 0
            },
            at = Math.max,
            lt = Math.min,
            ct = function(t) {
            ...
            dt = function(t, e) {
                var i, n = b(t),
                    r = 0,
                    o = [];
                for (i in n) !x($, i) && x(n, i) && o.push(i);
                for (; e.length > r;) x(n, i = e[r++]) && (~ut(o, i) || o.push(i));
                return o
            },
            ...
            yt = function(t, e) {
                for (var i = gt(e), n = O.f, r = k.f, o = 0; o < i.length; o++) {
                    var s = i[o];
                    x(t, s) || n(t, s, r(e, s))
                }
            },
            ...
            bt = function(t, e) {
                var i = wt[_t(t)];
                return i == xt || i != Tt && ("function" == typeof e ? l(e) : !!e)
            },
            _t = bt.normalize = function(t) {
            ...
            Et = k.f,
            Ct = function(t, e) {
                var i, n, r, o, s, l = t.target,
                    c = t.global,
                    u = t.stat;
                if (i = c ? a : u ? a[l] || Q(l, {}) : (a[l] || {}).prototype)
                    for (n in e) {
                        if (o = e[n], r = t.noTargetGet ? (s = Et(i, n)) && s.value : i[n], !Pt(c ? n : l + (u ? "." : "#") + n, t.forced) && void 0 !== r) {
                            if (typeof o == typeof r) continue;
                            yt(o, r)
                        }(t.sham || r && r.sham) && A(o, "sham", !0), Z(i, n, o, t)
                    }
            },
            St = function(t) {
            ...
            It = !!Object.getOwnPropertySymbols && !l(function() {
                return !String(Symbol())
            }),
            Ot = a.Symbol,
            At = z("wks"),
            Qt = function(t) {
                return At[t] || (At[t] = It && Ot[t] || (It ? Ot : B)("Symbol." + t))
            },
            zt = Qt("species"),
            Dt = function(t, e) {
                var i;
                return Yt(t) && ("function" != typeof(i = t.constructor) || i !== Array && !Yt(i.prototype) ? _(i) && null === (i = i[zt]) && (i = void 0) : i = void 0), new(void 0 === i ? Array : i)(0 === e ? 0 : e)
            },
            Lt = [].push,
            Mt = function(t) {
                var e = 1 == t,
                ...
                return function(a, l, c, u) {
                    for (var d, h, p = kt(a), f = y(p), m = jt(l, c, 3), g = st(f.length), v = 0, b = u || Dt, _ = e ? b(a, g) : i ? b(a, 0) : void 0; g > v; v++)
                        if ((s || v in f) && (h = m(d = f[v], v, p), t))
                            if (e) _[v] = h;
                            else if (h) switch (t) {
                        case 3:
                            return !0;
        ...
        for (var $t in Wt) {
            var qt = a[$t],
                Ht = qt && qt.prototype;
            if (Ht && Ht.forEach !== Nt) try {
                A(Ht, "forEach", Nt)
            } catch (t) {
                Ht.forEach = Nt
            }
        }
        var Vt = !("undefined" == typeof window || !window.document || !window.document.createElement),
            Ut = Qt("species"),
            Xt = Rt.filter;
        Ct({
            target: "Array",
            ...
            forced: !!l(function() {
                var t = [];
                return (t.constructor = {})[Ut] = function() {
                    return {
                        foo: 1
                    }
        ...
        var Gt = Object.keys || function(t) {
                return dt(t, ht)
            },
            Kt = c ? Object.defineProperties : function(t, e) {
                Y(t);
                for (var i, n = Gt(e), r = n.length, o = 0; r > o;) O.f(t, i = n[o++], e[i]);
                return t
            },
            Zt = et("document", "documentElement"),
            Jt = W("IE_PROTO"),
            te = function() {},
            ee = function() {
                var t, e = C("iframe"),
                    i = ht.length;
                for (e.style.display = "none", Zt.appendChild(e), e.src = String("javascript:"), (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), ee = t.F; i--;) delete ee.prototype[ht[i]];
                return ee()
            },
            ie = Object.create || function(t, e) {
                var i;
                return null !== t ? (te.prototype = Y(t), i = new te, te.prototype = null, i[Jt] = t) : i = ee(), void 0 === e ? i : Kt(i, e)
            };
        $[Jt] = !0;
        var ne = Qt("unscopables"),
            re = Array.prototype;
        null == re[ne] && A(re, ne, ie(null));
        var oe, se, ae, le = function(t) {
                re[ne][t] = !0
            },
            ce = {},
            ue = !l(function() {
            ...
            de = W("IE_PROTO"),
            he = Object.prototype,
            pe = ue ? Object.getPrototypeOf : function(t) {
                return t = kt(t), x(t, de) ? t[de] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? he : null
            },
            fe = Qt("iterator"),
            me = !1;
        [].keys && ("next" in (ae = [].keys()) ? (se = pe(pe(ae))) !== Object.prototype && (oe = se) : me = !0), null == oe && (oe = {}), x(oe, fe) || A(oe, fe, function() {
            return this
        });
        var ge = {
            ...
            ve = Qt("toStringTag"),
            be = function(t, e, i) {
                t && !x(t = i ? t : t.prototype, ve) && ye(t, ve, {
                    configurable: !0,
                    value: e
                })
            },
            ...
            Te = Object.setPrototypeOf || ("__proto__" in {} ? function() {
                ...
                return function(i, n) {
                    return Y(i),
                        function(t) {
                            if (!_(t) && null !== t) throw TypeError("Can't set " + String(t) + " as a prototype")
                        }(n), e ? t.call(i, n) : i.__proto__ = n, i
                }
            }() : void 0),
            xe = ge.IteratorPrototype,
            Pe = ge.BUGGY_SAFARI_ITERATORS,
            Ee = Qt("iterator"),
            Ce = function() {
                return this
            },
            Se = function(t, e, i, n, r, o, s) {
                ...
                var a, l, c, u = function(t) {
                    ...
                    h = !1,
                    f = t.prototype,
                    m = f[Ee] || f["@@iterator"] || r && f[r],
                    g = !Pe && m || u(r),
                    y = "Array" == e && f.entries || m;
                if (y && (a = pe(y.call(new t)), xe !== Object.prototype && a.next && (pe(a) !== xe && (Te ? Te(a, xe) : "function" != typeof a[Ee] && A(a, Ee, Ce)), be(a, d, !0))), "values" == r && m && "values" !== m.name && (h = !0, g = function() {
                        return m.call(this)
                    }), f[Ee] !== g && A(f, Ee, g), ce[e] = g, r)
                    if (l = {
                            values: u("values"),
                            keys: o ? g : u("keys"),
                            entries: u("entries")
                        }, s)
                        for (c in l) !Pe && !h && c in f || Z(f, c, l[c]);
                    else Ct({
                        target: e,
                        proto: !0,
                        forced: Pe || h
            ...
            je = K.set,
            ke = K.getterFor("Array Iterator"),
            Ye = Se(Array, "Array", function(t, e) {
                je(this, {
                    type: "Array Iterator",
                    target: b(t),
                    index: 0,
        ...
        ce.Arguments = ce.Array, le("keys"), le("values"), le("entries");
        var Ie = Object.assign,
            Oe = !Ie || l(function() {
                ...
                return t[i] = 7, "abcdefghijklmnopqrst".split("").forEach(function(t) {
                    e[t] = t
                }), 7 != Ie({}, t)[i] || "abcdefghijklmnopqrst" != Gt(Ie({}, e)).join("")
            }) ? function(t, e) {
                for (var i = kt(t), n = arguments.length, r = 1, o = mt.f, s = h.f; n > r;)
                    for (var a, l = y(arguments[r++]), u = o ? Gt(l).concat(o(l)) : Gt(l), d = u.length, p = 0; d > p;) a = u[p++], c && !s.call(l, a) || (i[a] = l[a]);
                return i
            } : Ie;
        Ct({
            target: "Object",
        ...
        var Ae = Qt("toStringTag"),
            Qe = "Arguments" == m(function() {
                return arguments
            }()),
            ze = function(t) {
                var e, i, n;
                ...
                }(e = Object(t), Ae)) ? i : Qe ? m(e) : "Object" == (n = m(e)) && "function" == typeof e.callee ? "Arguments" : n
            },
            De = {};
        De[Qt("toStringTag")] = "z";
        var Le = "[object z]" !== String(De) ? function() {
                return "[object " + ze(this) + "]"
            } : De.toString,
            Me = Object.prototype;
        Le !== Me.toString && Z(Me, "toString", Le, {
            unsafe: !0
        });
        var Re = "\t\n\v\f\r                　\u2028\u2029\ufeff",
            Fe = "[" + Re + "]",
            ...
            We = function(t) {
                return function(e) {
                    var i = String(v(e));
                    return 1 & t && (i = i.replace(Be, "")), 2 & t && (i = i.replace(Ne, "")), i
                }
            },
            $e = (We(1), We(2), We(3)),
            qe = a.parseInt,
            He = /^[+-]?0[Xx]/,
            Ve = 8 !== qe(Re + "08") || 22 !== qe(Re + "0x16") ? function(t, e) {
                var i = $e(String(t));
                return qe(i, e >>> 0 || (He.test(i) ? 16 : 10))
            } : qe;
        Ct({
            global: !0,
            forced: parseInt != Ve
        ...
        var Ue = function(t) {
                return function(e, i) {
                    var n, r, o = String(v(e)),
                        s = rt(i),
                        a = o.length;
                    return s < 0 || s >= a ? t ? "" : void 0 : (n = o.charCodeAt(s)) < 55296 || n > 56319 || s + 1 === a || (r = o.charCodeAt(s + 1)) < 56320 || r > 57343 ? t ? o.charAt(s) : n : t ? o.slice(s, s + 2) : r - 56320 + (n - 55296 << 10) + 65536
                }
            },
            Xe = {
                codeAt: Ue(!1),
            ...
            Ge = Xe.charAt,
            Ke = K.set,
            Ze = K.getterFor("String Iterator");
        Se(String, "String", function(t) {
            ...
            } : (t = Ge(i, n), e.index += t.length, {
                value: t,
                done: !1
            })
        });
        var Je = function(t, e, i) {
                for (var n in e) Z(t, n, e[n], i);
                return t
            },
            ti = !l(function() {
            ...
            ei = e(function(t) {
                var e = O.f,
                    ...
                    s = t.exports = {
                        ...
                        onFreeze: function(t) {
                            return ti && s.REQUIRED && r(t) && !x(t, i) && o(t), t
                        }
                    };
                $[i] = !0
            }),
            ii = (ei.REQUIRED, ei.fastKey, ei.getWeakData, ei.onFreeze, Qt("iterator")),
            ni = Array.prototype,
            ri = Qt("iterator"),
            oi = function(t, e, i, n) {
                try {
                    return n ? e(Y(i)[0], i[1]) : e(i)
                } catch (e) {
                    var r = t.return;
                    throw void 0 !== r && Y(r.call(t)), e
                }
            },
            si = e(function(t) {
                var e = function(t, e) {
                ...
                (t.exports = function(t, i, n, r, o) {
                    var s, a, l, c, u, d, h, p = jt(i, n, r ? 2 : 1);
                    if (o) s = t;
                    else {
                        if ("function" != typeof(a = function(t) {
                                if (null != t) return t[ri] || t["@@iterator"] || ce[ze(t)]
                            }(t))) throw TypeError("Target is not iterable");
                        if (void 0 !== (h = a) && (ce.Array === h || ni[ii] === h)) {
                            for (l = 0, c = st(t.length); c > l; l++)
                                if ((u = r ? p(Y(d = t[l])[0], d[1]) : p(t[l])) && u instanceof e) return u;
                            return new e(!1)
                        }
                        s = a.call(t)
                    }
                    for (; !(d = s.next()).done;)
                        if ((u = oi(s, p, d.value, r)) && u instanceof e) return u;
                    return new e(!1)
                }).stop = function(t) {
                    return new e(!0, t)
                }
        ...
        var hi = function(t, e, i, n, r) {
                var o = a[t],
                    ...
                    h = function(t) {
                        ...
                        Z(s, t, "add" == t ? function(t) {
                            ...
                            return !(r && !_(t)) && e.call(this, 0 === t ? 0 : t)
                        } : "get" == t ? function(t) {
                            return r && !_(t) ? void 0 : e.call(this, 0 === t ? 0 : t)
                        } : "has" == t ? function(t) {
                            return !(r && !_(t)) && e.call(this, 0 === t ? 0 : t)
                        } : function(t, i) {
                ...
                if (Pt(t, "function" != typeof o || !(r || s.forEach && !l(function() {
                        (new o).entries().next()
                    })))) c = i.getConstructor(e, t, n, u), ei.REQUIRED = !0;
                else if (Pt(t, !0)) {
                    var p = new c,
                        f = p[u](r ? {} : -0, 1) != p,
                        m = l(function() {
                    ...
                    g || ((c = e(function(e, i) {
                        ...
                        var r = function(t, e, i) {
                            var n, r;
                            return Te && "function" == typeof(n = e.constructor) && n !== i && _(r = n.prototype) && r !== i.prototype && Te(t, r), t
                        }(new o, e, c);
                        return null != i && si(i, r[u], r, n), r
                    })).prototype = s, s.constructor = c), (m || y) && (h("delete"), h("has"), n && h("get")), (y || f) && h(u), r && s.clear && delete s.clear
                }
                return d[t] = c, Ct({
                    global: !0,
                    forced: c != o
                }, d), be(c, t), r || i.setStrong(c, t, n), c
            },
            pi = ei.getWeakData,
            fi = K.set,
            mi = K.getterFor,
            ...
            vi = 0,
            bi = function(t) {
                return t.frozen || (t.frozen = new _i)
            },
            _i = function() {
                this.entries = []
            },
        ...
        var Ti = {
                getConstructor: function(t, e, i, n) {
                    var r = t(function(t, o) {
                        ...
                        s = function(t, e, i) {
                            var n = o(t),
                                r = pi(Y(e), !0);
                            return !0 === r ? bi(n).set(e, i) : r[n.id] = i, t
                        };
                    return Je(r.prototype, {
                        delete: function(t) {
                            ...
                            if (!_(t)) return !1;
                            var i = pi(t);
                            return !0 === i ? bi(e).delete(t) : i && x(i, e.id) && delete i[e.id]
                        },
                        has: function(t) {
                            var e = o(this);
                            if (!_(t)) return !1;
                            var i = pi(t);
                            return !0 === i ? bi(e).has(t) : i && x(i, e.id)
                        }
                    }), Je(r.prototype, i ? {
                        get: function(t) {
                            var e = o(this);
                            if (_(t)) {
                                var i = pi(t);
                                return !0 === i ? bi(e).get(t) : i ? i[e.id] : void 0
                            }
                        },
                        set: function(t, e) {
                            return s(this, t, e)
            ...
            xi = (e(function(t) {
                var e, i = K.enforce,
                    ...
                    s = t.exports = hi("WeakMap", o, Ti, !0, !0);
                if (M && n) {
                    e = Ti.getConstructor(o, "WeakMap", !0), ei.REQUIRED = !0;
                    var l = s.prototype,
                        c = l.delete,
                        u = l.has,
                        d = l.get,
                    ...
                    Je(l, {
                        ...
                        get: function(t) {
                            if (_(t) && !r(t)) {
                                var n = i(this);
                                return n.frozen || (n.frozen = new e), u.call(this, t) ? d.call(this, t) : n.frozen.get(t)
                            }
        ...
        var Yi = "Expected a function",
            ...
            Di = /^0o[0-7]+$/i,
            Li = parseInt,
            Mi = "object" == typeof t && t && t.Object === Object && t,
            Ri = "object" == typeof self && self && self.Object === Object && self,
            Fi = Mi || Ri || Function("return this")(),
        ...
        function Hi(t) {
            ...
            t = t.replace(Ai, "");
            var i = zi.test(t);
            return i || Di.test(t) ? Li(t.slice(2), i ? 2 : 8) : Qi.test(t) ? Ii : +t
        }
        var Vi = function(t, e, i) {
                var n = !0,
                    r = !0;
                if ("function" != typeof t) throw new TypeError(Yi);
                return qi(i) && (n = "leading" in i ? !!i.leading : n, r = "trailing" in i ? !!i.trailing : r),
                    function(t, e, i) {
                        var n, r, o, s, a, l, c = 0,
                            u = !1,
                            d = !1,
                        ...
                        function m() {
                            ...
                            a = setTimeout(m, function(t) {
                                var i = e - (t - l);
                                return d ? Wi(i, o - (t - c)) : i
                            }(t))
                        }

                        function g(t) {
                            return a = void 0, h && n ? p(t) : (n = r = void 0, s)
                        }
                        ...
                        return e = Hi(e) || 0, qi(i) && (u = !!i.leading, o = (d = "maxWait" in i) ? Ni(Hi(i.maxWait) || 0, e) : o, h = "trailing" in i ? !!i.trailing : h), y.cancel = function() {
        ...
        function un(t) {
            ...
            t = t.replace(Gi, "");
            var i = Zi.test(t);
            return i || Ji.test(t) ? tn(t.slice(2), i ? 2 : 8) : Ki.test(t) ? Ui : +t
        }
        var dn = function(t, e, i) {
                ...
                return e = un(e) || 0, cn(i) && (u = !!i.leading, o = (d = "maxWait" in i) ? sn(un(i.maxWait) || 0, e) : o, h = "trailing" in i ? !!i.trailing : h), y.cancel = function() {
                    void 0 !== a && clearTimeout(a), c = 0, n = l = r = a = void 0
                }, y.flush = function() {
                    return void 0 === a ? s : g(ln())
                }, y
            },
            ...
            yn = "object" == typeof t && t && t.Object === Object && t,
            vn = "object" == typeof self && self && self.Object === Object && self,
            bn = yn || vn || Function("return this")(),
            _n = Array.prototype,
            ...
            Sn = Tn.toString,
            jn = RegExp("^" + En.call(Cn).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
            kn = _n.splice,
            Yn = Ln(bn, "Map"),
            In = Ln(Object, "create");
        ...
        function Ln(t, e) {
            ...
            return function(t) {
                return !(!Rn(t) || (e = t, Pn && Pn in e)) && (function(t) {
                    var e = Rn(t) ? Sn.call(t) : "";
                    return e == fn || e == mn
                }(t) || function(t) {
                    var e = !1;
        ...
        function Mn(t, e) {
            if ("function" != typeof t || e && "function" != typeof e) throw new TypeError(hn);
            var i = function() {
                var n = arguments,
            ...
            return i.cache = new(Mn.Cache || Qn), i
        }
        ...
        var Fn = Mn,
            ...
            Wn = "undefined" != typeof global && global.Math === Math ? global : "undefined" != typeof self && self.Math === Math ? self : "undefined" != typeof window && window.Math === Math ? window : Function("return this")(),
            $n = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(Wn) : function(t) {
            ...
            Xn = function() {
                ...
                return t.prototype.addObserver = function(t) {
                    ...
                    Nn && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), Un ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                        attributes: !0,
                        childList: !0,
                        characterData: !0,
                        subtree: !0
            ...
            Kn = function(t) {
                return t && t.ownerDocument && t.ownerDocument.defaultView || Wn
            },
            Zn = nr(0, 0, 0, 0);
        ...
        function tr(t) {
            ...
            return e.reduce(function(e, i) {
                return e + Jn(t["border-" + i + "-width"])
            }, 0)
        }
        var er = "undefined" != typeof SVGGraphicsElement ? function(t) {
            return t instanceof Kn(t).SVGGraphicsElement
        } : function(t) {
            return t instanceof Kn(t).SVGElement && "function" == typeof t.getBBox
        };

        function ir(t) {
            return Nn ? er(t) ? function(t) {
                var e = t.getBBox();
                return nr(0, 0, e.width, e.height)
            }(t) : function(t) {
                var e = t.clientWidth,
                    i = t.clientHeight;
                if (!e && !i) return Zn;
                var n = Kn(t).getComputedStyle(t),
                    r = function(t) {
                    ...
                    a = Jn(n.width),
                    l = Jn(n.height);
                if ("border-box" === n.boxSizing && (Math.round(a + o) !== e && (a -= tr(n, "left", "right") + o), Math.round(l + s) !== i && (l -= tr(n, "top", "bottom") + s)), ! function(t) {
        ...
        var rr = function() {
            ...
            or = function(t, e) {
                var i, n, r, o, s, a, l, c = (n = (i = e).x, r = i.y, o = i.width, s = i.height, a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(a.prototype), Gn(l, {
                    x: n,
                    y: r,
                    width: o,
                    height: s,
            ...
            sr = function() {
                ...
                return t.prototype.observe = function(t) {
                    ...
                    if ("undefined" != typeof Element && Element instanceof Object) {
                        if (!(t instanceof Kn(t).Element)) throw new TypeError('parameter 1 is not of type "Element".');
                        var e = this.observations_;
                        e.has(t) || (e.set(t, new rr(t)), this.controller_.addObserver(this), this.controller_.refresh())
                    }
                    ...
                    if (this.hasActive()) {
                        var t = this.callbackCtx_,
                            e = this.activeObservations_.map(function(t) {
                                return new or(t.target, t.broadcastRect())
                            });
            ...
            ar = "undefined" != typeof WeakMap ? new WeakMap : new Bn,
            lr = function t(e) {
        ...
        var cr = void 0 !== Wn.ResizeObserver ? Wn.ResizeObserver : lr,
            ur = function(t) {
                return function(e, i, n, r) {
                    ...
                    for (; t ? l >= 0 : a > l; l += c) l in s && (r = i(r, s[l], l, o));
                    return r
                }
            },
            dr = [ur(!1), ur(!0)][0];
        Ct({
            ...
            reduce: function(t) {
                return dr(this, t, arguments.length, arguments.length > 1 ? arguments[1] : void 0)
            }
        });
        var hr = O.f,
            ...
            fr = pr.toString,
            mr = /^\s*function ([^ (]*)/;
        !c || "name" in pr || hr(pr, "name", {
            configurable: !0,
            get: function() {
                try {
                    return fr.call(this).match(mr)[1]
                } catch (t) {
                    return ""
                }
            }
        });
        var gr, yr, vr = RegExp.prototype.exec,
            br = String.prototype.replace,
            _r = vr,
            wr = (gr = /a/, yr = /b*/g, vr.call(gr, "a"), vr.call(yr, "a"), 0 !== gr.lastIndex || 0 !== yr.lastIndex),
            Tr = void 0 !== /()??/.exec("")[1];
        (wr || Tr) && (_r = function(t) {
            var e, i, n, r, o = this;
            return Tr && (i = new RegExp("^" + o.source + "$(?!\\s)", function() {
                var t = Y(this),
                    e = "";
                return t.global && (e += "g"), t.ignoreCase && (e += "i"), t.multiline && (e += "m"), t.dotAll && (e += "s"), t.unicode && (e += "u"), t.sticky && (e += "y"), e
            }.call(o))), wr && (e = o.lastIndex), n = vr.call(o, t), wr && n && (o.lastIndex = o.global ? n.index + n[0].length : e), Tr && n && n.length > 1 && br.call(n[0], i, function() {
                ...
                var r = Qt(t),
                    ...
                    s = o && !l(function() {
                        ...
                        return i.exec = function() {
                            return e = !0, null
                        }, "split" === t && (i.constructor = {}, i.constructor[Pr] = function() {
                            return i
                        }), i[r](""), !e
                    });
                if (!o || !s || "replace" === t && !Er || "split" === t && !Cr) {
                    var a = /./ [r],
                        c = i(r, "" [t], function(t, e, i, n, r) {
                            return e.exec === xr ? o && !r ? {
                                done: !0,
                                value: a.call(e, i, n)
                            } : {
                                done: !0,
                        ...
                        u = c[0],
                        d = c[1];
                    Z(String.prototype, t, u), Z(RegExp.prototype, r, 2 == e ? function(t, e) {
        ...
        Sr("match", 1, function(t, e, i) {
            return [function(e) {
                ...
                var r = Y(t),
                    o = String(this);
                if (!r.global) return Yr(r, o);
                var s = r.unicode;
                r.lastIndex = 0;
                for (var a, l = [], c = 0; null !== (a = Yr(r, o));) {
                    var u = String(a[0]);
                    l[c] = u, "" === u && (r.lastIndex = kr(o, st(r.lastIndex), s)), c++
                }
                return 0 === c ? null : l
            }]
        });
        ...
        Sr("replace", 2, function(t, e, i) {
            return [function(i, n) {
                ...
                for (var d = [];;) {
                    ...
                    if (null === h) break;
                    if (d.push(h), !c) break;
                    "" === String(h[0]) && (s.lastIndex = kr(a, st(s.lastIndex), u))
                }
                for (var p, f = "", m = 0, g = 0; g < d.length; g++) {
                    h = d[g];
                    for (var y = String(h[0]), v = Ir(Or(rt(h.index), a.length), 0), b = [], _ = 1; _ < h.length; _++) b.push(void 0 === (p = h[_]) ? p : String(p));
                    var w = h.groups;
                    if (l) {
                        var T = [y].concat(b, v, a);
                        void 0 !== w && T.push(w);
                        var x = String(r.apply(void 0, T))
                    } else x = n(y, a, v, b, w, r);
                    v >= m && (f += a.slice(m, v) + x, m = v + y.length)
                }
                return f + a.slice(m)
            }];
            ...
            function n(t, i, n, r, o, s) {
                var a = n + t.length,
                    l = r.length,
                    c = zr;
                return void 0 !== o && (o = kt(o), c = Qr), e.call(s, c, function(e, s) {
                    var c;
                    switch (s.charAt(0)) {
                        case "$":
                            return "$";
                        ...
                        default:
                            ...
                            if (u > l) {
                                var d = Ar(u / 10);
                                return 0 === d ? e : d <= l ? void 0 === r[d - 1] ? s.charAt(1) : r[d - 1] + s.charAt(1) : e
                            }
                            c = r[u - 1]
                    }
                    return void 0 === c ? "" : c
        ...
        function Br(t) {
            if (null === Rr) {
                var e = Mr(t);
                if (void 0 === e) return Rr = 0;
                var i = e.body,
                    n = e.createElement("div");
                n.classList.add("simplebar-hide-scrollbar"), i.appendChild(n);
                var r = n.getBoundingClientRect().right;
                i.removeChild(n), Rr = r
            }
            return Rr
        }
        Vt && window.addEventListener("resize", function() {
            Fr !== window.devicePixelRatio && (Fr = window.devicePixelRatio, Rr = null)
        });
        var Nr = function() {
            function t(e, i) {
                var n = this;
                this.onScroll = function() {
                    ...
                    var l = (("y" === n.draggedAxis ? e.pageY : e.pageX) - i.rect[n.axis[n.draggedAxis].offsetAttr] - n.axis[n.draggedAxis].dragOffset) / (r - o.size) * (s - a);
                    "x" === n.draggedAxis && (l = n.isRtl && t.getRtlHelpers().isRtlScrollbarInverted ? l - (r + o.size) : l, l = n.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -l : l), n.contentWrapperEl[n.axis[n.draggedAxis].scrollOffsetAttr] = l
                ...
                }, this.removePreventClickId = null, t.instances.has(this.el) || (this.recalculate = Vi(this.recalculate.bind(this), 64), this.onMouseMove = Vi(this.onMouseMove.bind(this), 64), this.hideScrollbars = dn(this.hideScrollbars.bind(this), this.options.timeout), this.onWindowResize = dn(this.onWindowResize.bind(this), 64, {
                    leading: !0
                }), t.getRtlHelpers = Fn(t.getRtlHelpers), this.init())
            }
            ...
            return e.init = function() {
                t.instances.set(this.el, this), Vt && (this.initDOM(), this.scrollbarWidth = this.getScrollbarWidth(), this.recalculate(), this.initListeners())
            }, e.initDOM = function() {
                var t = this;
                ...
                if (void 0 === e && (e = "y"), this.axis[e].isOverflowing) {
                    var i = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
                        ...
                        a = (s = "x" === e && this.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -s : s) / (i - r),
                        l = ~~((n - o.size) * a);
                    l = "x" === e && this.isRtl && t.getRtlHelpers().isRtlScrollbarInverted ? l + (n - o.size) : l, o.el.style.transform = "x" === e ? "translate3d(" + l + "px, 0, 0)" : "translate3d(0, " + l + "px, 0)"
                }
                ...
                if (void 0 === e && (e = "y"), this.options.clickOnTrack) {
                    ...
                    var r = this.axis[e].scrollbar.rect[this.axis[e].offsetAttr],
                        ...
                        l = -1 === a ? s - o : s + o;
                    ! function t() {
                        var r, o; - 1 === a ? s > l && (s -= i.options.clickOnTrackSpeed, i.contentWrapperEl.scrollTo(((r = {})[i.axis[e].offsetAttr] = s, r)), n.requestAnimationFrame(t)) : s < l && (s += i.options.clickOnTrackSpeed, i.contentWrapperEl.scrollTo(((o = {})[i.axis[e].offsetAttr] = s, o)), n.requestAnimationFrame(t))
                    }()
                }
                ...
                try {
                    return "none" === getComputedStyle(this.contentWrapperEl, "::-webkit-scrollbar").display || "scrollbarWidth" in document.documentElement.style || "-ms-overflow-style" in document.documentElement.style ? 0 : Br(this.el)
                } catch (t) {
                    return Br(this.el)
                }
        ...
        return Nr.defaultOptions = {
            ...
            document.removeEventListener("DOMContentLoaded", this.initDOMLoadedElements), window.removeEventListener("load", this.initDOMLoadedElements), Array.prototype.forEach.call(document.querySelectorAll("[data-simplebar]"), function(t) {
                "init" === t.getAttribute("data-simplebar") || Nr.instances.has(t) || new Nr(t, Dr(t.attributes))
            })
        ...
        }, Nr.handleMutations = function(t) {
            t.forEach(function(t) {
                Array.prototype.forEach.call(t.addedNodes, function(t) {
                    1 === t.nodeType && (t.hasAttribute("data-simplebar") ? !Nr.instances.has(t) && new Nr(t, Dr(t.attributes)) : Array.prototype.forEach.call(t.querySelectorAll("[data-simplebar]"), function(t) {
                        "init" === t.getAttribute("data-simplebar") || Nr.instances.has(t) || new Nr(t, Dr(t.attributes))
                    }))
                }), Array.prototype.forEach.call(t.removedNodes, function(t) {
                    1 === t.nodeType && (t.hasAttribute('[data-simplebar="init"]') ? Nr.instances.has(t) && Nr.instances.get(t).unMount() : Array.prototype.forEach.call(t.querySelectorAll('[data-simplebar="init"]'), function(t) {
                        Nr.instances.has(t) && Nr.instances.get(t).unMount()
                    }))
                })
            })
        }, Nr.getOptions = Dr, Vt && Nr.initHtmlApi(), Nr
    });
        ...
        return t.fn.tilt.destroy = function() {
            ...
            this.settings = t.extend({
                ...
                t(i).data("settings", i.settings), i.settings.glare && function() {
                    ...
                    function() {
                        t(this).on("mousemove", s), t(this).on("mouseenter", r), this.settings.reset && t(this).on("mouseleave", a), this.settings.glare && t(window).on("resize", function() {
                            this.glareElement.css({
                                width: "" + 2 * t(this).outerWidth(),
                                height: "" + 2 * t(this).outerWidth()
                            })
...
var pJS = function(t, e) {
    ...
    e && Object.deepExtend(n, e), n.tmp.obj = {
        ...
        n.particles.move.straight ? (this.vx = o.x, this.vy = o.y, n.particles.move.random && (this.vx = this.vx * Math.random(), this.vy = this.vy * Math.random())) : (this.vx = o.x + Math.random() - .5, this.vy = o.y + Math.random() - .5), this.vx_i = this.vx, this.vy_i = this.vy;
        ...
        else r = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + i + ")";
        switch (n.canvas.ctx.fillStyle = r, n.canvas.ctx.beginPath(), t.shape) {
            ...
            case "star":
                ...
                break;
            case "image":
                if ("svg" == n.tmp.img_type) var o = t.img.obj;
                else o = n.tmp.img_obj;
                o && n.canvas.ctx.drawImage(o, t.x - e, t.y - e, 2 * e, 2 * e / t.img.ratio)
        }
        ...
        function i(e, i, r, o, s) {
            if (e != i)
                if (n.tmp.bubble_duration_end) {
                    if (null != r) l = e + (e - (o - d * (o - e) / n.interactivity.modes.bubble.duration)), "size" == s && (t.radius_bubble = l), "opacity" == s && (t.opacity_bubble = l)
        ...
        if (n.interactivity.events.onhover.enable && isInArray("bubble", n.interactivity.events.onhover.mode)) {
            var r = t.x - n.interactivity.mouse.pos_x,
                ...
                s = 1 - (u = Math.sqrt(r * r + o * o)) / n.interactivity.modes.bubble.distance;
            if (u <= n.interactivity.modes.bubble.distance) {
                if (s >= 0 && "mousemove" == n.interactivity.status) {
                    if (n.interactivity.modes.bubble.size != n.particles.size.value)
                        if (n.interactivity.modes.bubble.size > n.particles.size.value) {
                            (l = t.radius + n.interactivity.modes.bubble.size * s) >= 0 && (t.radius_bubble = l)
                        } else {
                            var a = t.radius - n.interactivity.modes.bubble.size,
                                l = t.radius - a * s;
                            t.radius_bubble = l > 0 ? l : 0
                        }
                    if (n.interactivity.modes.bubble.opacity != n.particles.opacity.value)
                        if (n.interactivity.modes.bubble.opacity > n.particles.opacity.value) {
                            (c = n.interactivity.modes.bubble.opacity * s) > t.opacity && c <= n.interactivity.modes.bubble.opacity && (t.opacity_bubble = c)
                        } else {
                            var c;
                            (c = t.opacity - (n.particles.opacity.value - n.interactivity.modes.bubble.opacity) * s) < t.opacity && c >= n.interactivity.modes.bubble.opacity && (t.opacity_bubble = c)
                        }
                }
            } else e();
            ...
            if (n.tmp.bubble_clicking) {
                r = t.x - n.interactivity.mouse.click_pos_x, o = t.y - n.interactivity.mouse.click_pos_y;
        ...
        if (n.interactivity.events.onhover.enable && isInArray("repulse", n.interactivity.events.onhover.mode) && "mousemove" == n.interactivity.status) {
            var e = t.x - n.interactivity.mouse.pos_x,
                ...
                s = clamp(1 / (l = n.interactivity.modes.repulse.distance) * (-1 * Math.pow(r / l, 2) + 1) * l * 100, 0, 50),
                a = {
                    x: t.x + o.x * s,
                    y: t.y + o.y * s
                };
        ...
        if (n.interactivity.events.onhover.enable && "mousemove" == n.interactivity.status) {
            ...
            if (r <= n.interactivity.modes.grab.distance) {
                ...
                if (o > 0) {
                    ...
                    n.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + o + ")", n.canvas.ctx.lineWidth = n.particles.line_linked.width, n.canvas.ctx.beginPath(), n.canvas.ctx.moveTo(t.x, t.y), n.canvas.ctx.lineTo(n.interactivity.mouse.pos_x, n.interactivity.mouse.pos_y), n.canvas.ctx.stroke(), n.canvas.ctx.closePath()
                }
            }
        }
        ...
        for (var i = 0; i < n.particles.array.length; i++) {
            var r = n.particles.array[i],
                o = t.x - r.x,
                s = t.y - r.y;
            Math.sqrt(o * o + s * s) <= t.radius + r.radius && (t.x = e ? e.x : Math.random() * n.canvas.w, t.y = e ? e.y : Math.random() * n.canvas.h, n.fn.vendors.checkOverlap(t))
        }
    }, n.fn.vendors.createSvgImg = function(t) {
        var e = n.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(e, i, n, r) {
        ...
        s.addEventListener("load", function() {
            t.img.obj = s, t.img.loaded = !0, r.revokeObjectURL(o), n.tmp.count_svg++
        }), s.src = o
    }, n.fn.vendors.destroypJS = function() {
        cancelAnimationFrame(n.fn.drawAnimFrame), i.remove(), pJSDom = null
    }, n.fn.vendors.drawShape = function(t, e, i, n, r, o) {
        var s = r * o,
            a = r / o,
            l = 180 * (a - 2) / a,
        ...
        (i = function(i, n) {
            ...
            var a = {
                    ...
                    images: function() {
                        ...
                        t.removeAttr("width").removeAttr("height").css({
                            ...
                            var t = r.image._aspectRatio(this),
                                i = this;
                            if (e.data(this, "processed")) r.image._scale(i, t), r.image._center(i, t);
                            else {
                                var n = new Image;
                                n.onload = function() {
                                    r.image._scale(i, t), r.image._center(i, t), e.data(i, "processed", !0)
                                }, n.src = this.src
                            }
                        })
                    },
                    children: function() {
                        ...
                        }), t = r.$container.children()), r.init || t.css({
                            display: "none",
                            left: 2 * r.width
                        }), t.css({
                            position: "absolute",
                ...
                l = {
                    slide: function(t, e) {
                        ...
                        i.eq(t.upcoming_slide).css({
                            ...
                            left: t.offset
                        }, r.options.animation_speed, r.options.animation_easing, function() {
                            r.size() > 1 && (r.$control.css({
                                left: -r.width
                            }), i.eq(t.upcoming_slide).css({
                                left: r.width,
                                zIndex: 2
                    ...
                    fade: function(t, e) {
                        ...
                        o.css({
                            ...
                            opacity: 1
                        }, i.options.animation_speed, i.options.animation_easing), t.outgoing_slide >= 0 ? r.animate({
                            opacity: 0
            ...
            var c = {
                ...
                u = {
                    ...
                    _addItem: function(t) {
                        var i = t + 1,
                            n = r.$container.children().eq(t).attr("id");
                        n && (i = n), e("<a>", {
                            href: "#" + i,
                            text: i
                    ...
                    _setup: function() {
                        if (r.options.pagination && 1 !== r.size()) {
                            ...
                            for (var i = 0; r.size() > i; i++) r.pagination._addItem(i)
                        }
                    },
                    _events: function() {
                        r.$el.on("click", r.options.elements.pagination + " a", function(t) {
                            t.preventDefault();
                            var e, i = r._parseHash(this.hash);
                            (e = r._upcomingSlide(i, !0)) !== r.current && r.animate(e, function() {
                                r.start()
                            })
                        })
                    }
                };
            return this.css = a, this.image = c, this.pagination = u, this.fx = l, this.animation = this.fx[this.options.animation], this.$control = this.$container.wrap(o).parent(".slides-control"), r._findPositions(), r.width = r._findWidth(), r.height = r._findHeight(), this.css.children(), this.css.containers(), this.css.images(), this.pagination._setup(), s = r._findMultiplier(), r.$el.on("click", r.options.elements.nav + " a", function(t) {
                t.preventDefault(), r.stop(), e(this).hasClass("next") ? r.animate("next", function() {
                    r.start()
                }) : r.animate("prev", function() {
                    r.start()
                })
            }), e(document).on("keyup", function(t) {
                37 === t.keyCode && r.animate("prev"), 39 === t.keyCode && r.animate("next")
            }), e(t).on("resize", function() {
                setTimeout(function() {
                    var t = r.$container.children();
                    r.width = r._findWidth(), r.height = r._findHeight(), t.css({
                        width: r.width,
                        left: r.width
                    }), r.css.containers(), r.css.images()
                }, 10)
            }), r.options.hashchange && e(t).on("hashchange", function() {
                var t, e = r._parseHash();
                (t = r._upcomingSlide(e)) >= 0 && t !== r.current && r.animate(t)
            }), r.pagination._events(), r.start(), r
        }).prototype = {
            _findWidth: function() {
            ...
            _findPositions: function(t, e) {
                void 0 === t && (t = -1), (e = e || this).current = t, e.next = e._nextInDom(), e.prev = e._prevInDom()
            },
            _nextInDom: function() {
            ...
            _parseHash: function(e) {
                return (e = (e = e || t.location.hash).replace(/^#/, "")) && !isNaN(+e) && (e = +e), e
            },
            size: function() {
            ...
            animate: function(e, i) {
                var n = this,
                    r = {};
                if (!(this.animating || (this.animating = !0, void 0 === e && (e = "next"), r.upcoming_slide = this._upcomingSlide(e), r.upcoming_slide >= this.size()))) {
                    if (r.outgoing_slide = this.current, r.upcoming_position = 2 * this.width, r.offset = -r.upcoming_position, ("prev" === e || r.outgoing_slide > e) && (r.upcoming_position = 0, r.offset = 0), n.size() > 1 && n.pagination._setCurrent(r.upcoming_slide), n.options.hashchange) {
                        var o = r.upcoming_slide + 1,
                            s = n.$container.children(":eq(" + r.upcoming_slide + ")").attr("id");
                        t.location.hash = s || o
                    }
                    n.$el.trigger("animating.slides", [r]), n.animation(r, function() {
                        n._findPositions(r.upcoming_slide, n), "function" == typeof i && i(), n.animating = !1, n.$el.trigger("animated.slides"), n.init || (n.$el.trigger("init.slides"), n.init = !0, n.$container.fadeIn("fast"))
                    })
                }
            }
        }, e.fn[n] = function(t, r) {
            ...
            return this.each(function() {
                var s, a, l;
                return a = (s = e(this)).data(n), l = "object" == typeof t && t, a || (o = s.data(n, a = new i(this, l))), "string" == typeof t && "function" == typeof(o = a[t]) ? o = o.call(a, r) : void 0
            }), o
        }, e.fn[n].fx = {}
    }(this, jQuery),
    function(t, e) {
        ...
        function e(t) {
            var e, i, n, r, o, s, a, l = {};
            for (a = 0, s = (o = t.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(",")).length; a < s && (-1 === (i = o[a]).search(/^(http|https|ftp):\/\//) && -1 !== i.search(":")); a++) e = i.indexOf(":"), n = i.substring(0, e), (r = i.substring(e + 1)) || (r = void 0), "string" == typeof r && (r = "true" === r || "false" !== r && r), "string" == typeof r && (r = isNaN(r) ? r : +r), l[n] = r;
        ...
        i.prototype.init = function() {
            var e, i, n = this,
                ...
                c = n.settings,
                u = function(t) {
                    var e, i, n, r = (t = "" + t).split(/\s+/),
                        o = "50%",
                        s = "50%";
                    for (n = 0, e = r.length; n < e; n++) "left" === (i = r[n]) ? o = "0%" : "right" === i ? o = "100%" : "top" === i ? s = "0%" : "bottom" === i ? s = "100%" : "center" === i ? 0 === n ? o = "50%" : s = "50%" : 0 === n ? o = i : s = i;
                    return {
                        x: o,
                        y: s
                    }
            ...
            }), "object" == typeof r && (r.poster ? s = r.poster : r.mp4 ? s = r.mp4 : r.webm ? s = r.webm : r.ogv && (s = r.ogv)), "detect" === d ? function(e, i) {
                var n = function() {
                    i(this.src)
                };
            ...
            }) : "none" !== d && i.css("background-image", "url(" + s + "." + d + ")"), "static" === l.css("position") && l.css("position", "relative"), l.prepend(i), "object" == typeof r ? (r.mp4 && (a += '<source src="' + r.mp4 + '.mp4" type="video/mp4">'), r.webm && (a += '<source src="' + r.webm + '.webm" type="video/webm">'), r.ogv && (a += '<source src="' + r.ogv + '.ogv" type="video/ogg">'), e = n.$video = t("<video>" + a + "</video>")) : e = n.$video = t('<video><source src="' + r + '.mp4" type="video/mp4"><source src="' + r + '.webm" type="video/webm"><source src="' + r + '.ogv" type="video/ogg"></video>');
            try {
                e.prop({
                    autoplay: c.autoplay,
                    loop: c.loop,
            ...
            var o;
            return this.each(function() {
                (o = t.data(this, n)) && o.destroy(), (o = new i(this, e, r)).index = t[n].lookup.push(o) - 1, t.data(this, n, o)
            }), this
        }, t(document).ready(function() {
            var e = t(window);
            e.on("resize.vide", function() {
                for (var e, i = t[n].lookup.length, r = 0; r < i; r++)(e = t[n].lookup[r]) && e.settings.resizing && e.resize()
...
var getYTPVideoID = function(t) {
    var e, i;
    return t.indexOf("youtu.be") > 0 ? e = (i = (e = t.substr(t.lastIndexOf("/") + 1, t.length)).indexOf("?list=") > 0 ? e.substr(e.lastIndexOf("="), e.length) : null) ? e.substr(0, e.lastIndexOf("?")) : e : t.indexOf("http") > -1 ? (e = t.match(/[\\?&]v=([^&#]*)/)[1], i = t.indexOf("list=") > 0 ? t.match(/[\\?&]list=([^&#]*)/)[1] : null) : i = (e = t.length > 15 ? null : t) ? null : t, {
        videoID: e,
        playlistID: i
    }
};
...
function setFilter(t, e, i) {
    ...
    jQuery.mbYTPlayer = {
        ...
        playlist: function(t, e, i, n) {
            var r = this.get(0);
            return r.isPlayList = !0, e && (t = jQuery.shuffle(t)), r.videoID || (r.videos = t, r.videoCounter = 0, r.videoLength = t.length, jQuery(r).data("property", t[0]), jQuery(r).mb_YTPlayer()), "function" == typeof i && jQuery(r).one("YTPChanged", function() {
                i(r)
        ...
        playNext: function(t) {
            var e = this.get(0);
            return e.checkForStartAt && (clearTimeout(e.checkForStartAt), clearInterval(e.getState)), e.videoCounter++, e.videoCounter >= e.videoLength && t && (e.videoCounter = 0), e.videoCounter < e.videoLength ? jQuery(e).changeMovie(e.videos[e.videoCounter]) : e.videoCounter--, this
        },
        playPrev: function() {
            var t = this.get(0);
        ...
        playIndex: function(t) {
            var e = this.get(0);
            return t -= 1, e.checkForStartAt && (clearInterval(e.checkForStartAt), clearInterval(e.getState)), e.videoCounter = t, e.videoCounter >= e.videoLength - 1 && (e.videoCounter = e.videoLength - 1), jQuery(e).changeMovie(e.videos[e.videoCounter]), this
        },
        changeMovie: function(t) {
            var e = this.get(0);
            e.opt.startAt = 0, e.opt.stopAt = 0, e.opt.mask = !1, e.opt.mute = !0, e.hasData = !1, e.hasChanged = !0, e.player.loopTime = void 0, t && jQuery.extend(e.opt, t), e.videoID = getYTPVideoID(e.opt.videoURL).videoID, "true" == e.opt.loop && (e.opt.loop = 9999), jQuery(e.playerEl).CSSAnimate({
                opacity: 0
            }, 200, function() {
                var t = jQuery.Event("YTPChangeMovie");
                t.time = e.currentTime, t.videoId = e.videoID, jQuery(e).trigger(t), jQuery(e).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + e.videoID), 1, e.opt.quality), jQuery(e).optimizeDisplay(), jQuery.mbYTPlayer.checkForState(e), jQuery.mbYTPlayer.getDataFromAPI(e)
        ...
        playerDestroy: function() {
            var t = this.get(0);
            return ytp.YTAPIReady = !0, ytp.backgroundIsInited = !1, t.isInit = !1, t.videoID = null, t.wrapper.remove(), jQuery("#controlBar_" + t.id).remove(), clearInterval(t.checkForStartAt), clearInterval(t.getState), this
        },
        fullscreen: function(real) {
            ...
            function RunPrefixMethod(t, e) {
                for (var i, n, r = ["webkit", "moz", "ms", "o", ""], o = 0; o < r.length && !t[i];) {
                    if (i = e, "" == r[o] && (i = i.substr(0, 1).toLowerCase() + i.substr(1)), "undefined" != (n = typeof t[i = r[o] + i])) return r = [r[o]], "function" == n ? t[i]() : t[i];
                    o++
                }
            }
        ...
        play: function() {
            var t = this.get(0);
            return t.isReady ? (t.player.playVideo(), t.wrapper.CSSAnimate({
                opacity: t.isAlone ? 1 : t.opt.opacity
            }, 2e3), jQuery(t.playerEl).CSSAnimate({
                opacity: 1
            }, 1e3), jQuery("#controlBar_" + t.id).find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.pause), t.state = 1, jQuery(t).css("background-image", "none"), this) : this
        },
        ...
        mute: function() {
            ...
            if (!t.isMute) {
                ...
                return e.time = t.currentTime, t.canTrigger && jQuery(t).trigger(e), this
            }
        },
        unmute: function() {
            var t = this.get(0);
        ...
        applyFilter: function(t, e) {
            return this.each(function() {
                this.filters[t].value = e, this.filtersEnabled && jQuery(this).YTPEnableFilters()
            })
        },
        ...
        removeFilter: function(t, e) {
            return this.each(function() {
                if ("function" == typeof t && (e = t, t = null), t) jQuery(this).YTPApplyFilter(t, 0), "function" == typeof e && e(t);
                else
                    for (var i in this.filters) jQuery(this).YTPApplyFilter(i, 0), "function" == typeof e && e(i)
            })
        },
        getFilters: function() {
        ...
        applyMask: function(t) {
            var e = jQuery(t);
            if (e.off("YTPTime.mask"), t.opt.mask)
                if ("string" == typeof t.opt.mask) e.YTPAddMask(t.opt.mask), t.actualMask = t.opt.mask;
            ...
            if (data.showYTLogo = data.showYTLogo || data.printUrl, !jQuery("#controlBar_" + YTPlayer.id).length) {
                ...
                var movieUrl = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTPUrl ytpicon").attr("title", "view on YouTube").on("click", function() {
                    ...
                    progressBar = jQuery("<div/>").addClass("mb_YTPProgress").css("position", "absolute").click(function(t) {
                        ...
                        YTPlayer.goto = timeBar.outerWidth() * e / progressBar.outerWidth(), YTPlayer.player.seekTo(parseFloat(YTPlayer.goto), !0), YTPlayer.controlBar.find(".mb_YTPLoaded").css({
                            width: 0
                        })
                    }),
            ...
            jQuery.mbYTPlayer.checkForStart(YTPlayer), YTPlayer.getState = setInterval(function() {
                ...
                if (YTPlayer.currentTime = prog.currentTime, YTPlayer.totalTime = YTPlayer.player.getDuration(), 0 == YTPlayer.player.getVolume() ? $YTPlayer.addClass("isMuted") : $YTPlayer.removeClass("isMuted"), YTPlayer.opt.showControls && (prog.totalTime ? YTPlayer.controlBar.find(".mb_YTPTime").html(jQuery.mbYTPlayer.formatTime(prog.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(prog.totalTime)) : YTPlayer.controlBar.find(".mb_YTPTime").html("-- : -- / -- : --")), eval(YTPlayer.opt.stopMovieOnBlur) && (document.hasFocus() ? document.hasFocus() && !YTPlayer.hasFocus && -1 != YTPlayer.state && 0 != YTPlayer.state && (YTPlayer.hasFocus = !0, $YTPlayer.YTPPlay()) : 1 == YTPlayer.state && (YTPlayer.hasFocus = !1, $YTPlayer.YTPPause())), YTPlayer.controlBar.length && YTPlayer.controlBar.outerWidth() <= 400 && !YTPlayer.isCompact ? (YTPlayer.controlBar.addClass("compact"), YTPlayer.isCompact = !0, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)) : YTPlayer.controlBar.length && YTPlayer.controlBar.outerWidth() > 400 && YTPlayer.isCompact && (YTPlayer.controlBar.removeClass("compact"), YTPlayer.isCompact = !1, !YTPlayer.isMute && YTPlayer.volumeBar && YTPlayer.volumeBar.updateSliderVal(YTPlayer.opt.vol)), 1 == YTPlayer.player.getPlayerState() && (parseFloat(YTPlayer.player.getDuration() - 1.5) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                    ...
                    if (YTPlayer.isEnded = !0, setTimeout(function() {
                        ...
                        t.time = YTPlayer.currentTime, jQuery(YTPlayer).trigger(t), YTPlayer.player.seekTo(startAt, !0), YTPlayer.isBackground || YTPlayer.opt.containment.css({
                ...
                t.player.playVideo(), t.player.seekTo(n, !0), t.checkForStartAt = setInterval(function() {
                    ...
                    if (t.player.getDuration() > 0 && t.player.getCurrentTime() >= n && i) {
                        ...
                        if (r.time = t.currentTime, jQuery(t).trigger(r), t.preventTrigger = !0, t.state = 2, jQuery(t).YTPPause(), t.opt.mute || jQuery(t).YTPUnmute(), t.canTrigger = !0, t.opt.autoPlay) {
                            ...
                            o.time = t.currentTime, jQuery(t).trigger(o), e.css("background-image", "none"), jQuery(t.playerEl).CSSAnimate({
                                opacity: 1
                            }, 1e3), e.YTPPlay(), t.wrapper.CSSAnimate({
                                opacity: t.isAlone ? 1 : t.opt.opacity
                            }, 1e3), jQuery.browser.safari && (t.safariPlay = setInterval(function() {
                                1 != t.state ? e.YTPPlay() : clearInterval(t.safariPlay)
                            }, 10)), e.on("YTPReady", function() {
                                e.YTPPlay()
                            })
                        } else t.player.pauseVideo(), t.isPlayer || (jQuery(t.playerEl).CSSAnimate({
                            opacity: 1
                        }, 500), t.wrapper.CSSAnimate({
                            opacity: t.isAlone ? 1 : t.opt.opacity
                        }, 500)), t.controlBar.length && t.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
                    ...
                    } else jQuery.browser.safari && (t.player.playVideo(), n >= 0 && t.player.seekTo(n, !0))
                }, 1)
        ...
        var e = this.get(0),
            i = jQuery(e.playerEl),
            n = {};
        e.opt.align = t || e.opt.align, e.opt.align = "undefined " != typeof e.opt.align ? e.opt.align : "center,center";
        var r = e.opt.align.split(",");
        if (e.opt.optimizeDisplay) {
            var o = {},
                s = e.wrapper;
            o.width = s.outerWidth(), o.height = s.outerHeight(), n.width = o.width, n.height = "16/9" == e.opt.ratio ? Math.ceil(o.width * (9 / 16)) : Math.ceil(.75 * o.width), n.width = o.width, n.height = "16/9" == e.opt.ratio ? Math.ceil(o.width * (9 / 16)) : Math.ceil(.75 * o.width), n.marginTop = -(n.height - o.height) / 2, n.marginLeft = 0;
            var a = n.height < o.height;
            for (var l in a && (n.height = o.height, n.width = "16/9" == e.opt.ratio ? Math.floor(o.height * (16 / 9)) : Math.floor(o.height * (4 / 3)), n.marginTop = 0, n.marginLeft = -(n.width - o.width) / 2), r) switch (r[l].trim()) {
                case "top":
    ...
    normalizeCss: function(t) {
        ...
        for (var i in jQuery.browser.webkit || jQuery.browser.opera ? jQuery.CSS.sfx = "-webkit-" : jQuery.browser.mozilla ? jQuery.CSS.sfx = "-moz-" : jQuery.browser.msie && (jQuery.CSS.sfx = "-ms-"), e) {
    ...
    animate: function(t, e, i, n, r) {
        return this.each(function() {
            ...
            if (s.CSSAIsRunning && s.eventType == l.type && !jQuery.browser.msie && jQuery.browser.version <= 9) s.CSSqueue = function() {
                ...
                if (t = jQuery.normalizeCss(t), s.CSSAIsRunning = !0, "function" == typeof e && (r = e, e = jQuery.fx.speeds._default), "function" == typeof i && (n = i, i = 0), "string" == typeof i && (r = i, i = 0), "function" == typeof n && (r = n, n = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof e)
                ...
                if (e || (e = jQuery.fx.speeds._default), "string" == typeof r && (n = r, r = null), !jQuery.support.CSStransition) {
                    for (var u in t) {
                        if ("transform" === u && delete t[u], "filter" === u && delete t[u], "transform-origin" === u && delete t[u], "auto" === t[u] && delete t[u], "x" === u) {
                            var d = t[u];
                            t.left = d, delete t[u]
                        }
                        "y" === u && (d = t[u], t.top = d, delete t[u]), ("-ms-transform" === u || "-ms-filter" === u) && delete t[u]
                    }
                ...
                h[n] && (n = h[n]), a.off(jQuery.CSS.transitionEnd + "." + s.id);
                var p = jQuery.CSS.getProp(t),
                    f = {};
                jQuery.extend(f, t), f[jQuery.CSS.sfx + "transition-property"] = p, f[jQuery.CSS.sfx + "transition-duration"] = e + "ms", f[jQuery.CSS.sfx + "transition-delay"] = i + "ms", f[jQuery.CSS.sfx + "transition-timing-function"] = n, setTimeout(function() {
                    a.one(jQuery.CSS.transitionEnd + "." + s.id, o), a.css(f)
...
jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.isMobile = jQuery.browser.mobile, jQuery.isTablet = jQuery.browser.mobile && jQuery(window).width() > 765, jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt),
    function(t) {
        var e = (/iphone|ipod|ipad|android|ie|blackberry|fennec/.test(navigator.userAgent.toLowerCase()), "ontouchstart" in window || window.navigator && window.navigator.msPointerEnabled && window.MSGesture || window.DocumentTouch && document instanceof DocumentTouch || !1);
        t.simpleSlider = {
            defaults: {
                initialval: 0,
                scale: 100,
            ...
            init: function(i) {
                return this.each(function() {
                    var n = this,
                        r = t(n);
                    r.addClass("simpleSlider"), n.opt = {}, t.extend(n.opt, t.simpleSlider.defaults, i), t.extend(n.opt, r.data());
                    var o = "h" == n.opt.orientation ? "horizontal" : "vertical",
                        s = t("<div/>").addClass("level").addClass(o);
                    r.prepend(s), n.level = s, r.css({
                        cursor: "default"
                    }), "auto" == n.opt.scale && (n.opt.scale = t(n).outerWidth()), r.updateSliderVal(), n.opt.readonly || (r.on(t.simpleSlider.events.start, function(t) {
                        e && (t = t.changedTouches[0]), n.canSlide = !0, r.updateSliderVal(t), r.css({
                            cursor: "col-resize"
                        }), t.preventDefault(), t.stopPropagation()
                    }), t(document).on(t.simpleSlider.events.move, function(i) {
                        e && (i = i.changedTouches[0]), n.canSlide && (t(document).css({
                            cursor: "default"
                        }), r.updateSliderVal(i), i.preventDefault(), i.stopPropagation())
            ...
            updateSliderVal: function(e) {
                ...
                if (r.opt) {
                    ...
                    var o = t(r).outerWidth(),
                        s = t(r).outerHeight();
                    r.x = "object" == typeof e ? e.clientX + document.body.scrollLeft - n.offset().left : "number" == typeof e ? e * o / r.opt.scale : r.opt.initialval * o / r.opt.scale, r.y = "object" == typeof e ? e.clientY + document.body.scrollTop - n.offset().top : "number" == typeof e ? (r.opt.scale - r.opt.initialval - e) * s / r.opt.scale : r.opt.initialval * s / r.opt.scale, r.y = n.outerHeight() - r.y, r.scaleX = r.x * r.opt.scale / o, r.scaleY = r.y * r.opt.scale / s, r.outOfRangeX = r.scaleX > r.opt.scale ? r.scaleX - r.opt.scale : r.scaleX < 0 ? r.scaleX : 0, r.outOfRangeY = r.scaleY > r.opt.scale ? r.scaleY - r.opt.scale : r.scaleY < 0 ? r.scaleY : 0, r.outOfRange = "h" == r.opt.orientation ? r.outOfRangeX : r.outOfRangeY, r.value = void 0 !== e ? "h" == r.opt.orientation ? r.x >= n.outerWidth() ? r.opt.scale : r.x <= 0 ? 0 : r.scaleX : r.y >= n.outerHeight() ? r.opt.scale : r.y <= 0 ? 0 : r.scaleY : "h" == r.opt.orientation ? r.scaleX : r.scaleY, "h" == r.opt.orientation ? r.level.width(i(r.x, o) + "%") : r.level.height(i(r.y, s)), "function" == typeof r.opt.callback && r.opt.callback(r)
                }
            }
    ...
    function(t) {
        t.mbCookie = {
            set: function(t, e, i, n) {
                ...
                var r, o = new Date;
                o.setTime(o.getTime() + 864e5 * i), r = "; expires=" + o.toGMTString(), document.cookie = t + "=" + e + r + "; path=/" + n
            },
            get: function(t) {
